* @ValidationCode : MjoxNDI1ODk2MzU0OkNwMTI1MjoxNjgzMDMxMzcyNjE1OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 02 May 2023 18:12:52
...
****************
    ...
    Y.FT.OUT.LIST=''
*CALL APAP.REDOAPAP.REDO.APAP.SAP.GL.DETAIL.RPT.SPLIT.1(Y.STMT.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    CALL APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.STMT.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
...
****************
    ...
    Y.FT.OUT.LIST=''
    CALL APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.RE.CONSOL.SPEC.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    GOSUB WRITE.DATA.TO.SESSION.FILES
...
*****************
    ...
    Y.FT.OUT.LIST=''
    CALL APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.CATEG.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    GOSUB WRITE.DATA.TO.SESSION.FILES
