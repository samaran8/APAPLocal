...
*2-5-2023     CONVERSION TOOL     R22 AUTO CONVERSION     VM TO @VM,FM TO @FM,= TO EQ
...
** INPUT
    ...
    IF AF EQ FT.DEBIT.AMOUNT THEN ;*R22 AUTO CONVERSION
