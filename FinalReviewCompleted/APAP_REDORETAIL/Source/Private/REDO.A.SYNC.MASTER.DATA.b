...
*CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT('VPL002', 'ONLINE', '04', 'EMAIL ERROR ARCHIVO NO MONETARIO [' : WS.DATA<1> : '] - ' : WS.DATA<2>, 'REVISAR EN LOG $JBOSS_HOME\server\default\log\server.log ERROR EN ARCHIVO NO MONETARIO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '')
        CALL APAP.REDOSRTN.redoSNotifyInterfaceAct('VPL002', 'ONLINE', '04', 'EMAIL ERROR ARCHIVO NO MONETARIO [' : WS.DATA<1> : '] - ' : WS.DATA<2>, 'REVISAR EN LOG $JBOSS_HOME\server\default\log\server.log ERROR EN ARCHIVO NO MONETARIO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '')  ;* MANUAL R22 CODE CONVERSION
