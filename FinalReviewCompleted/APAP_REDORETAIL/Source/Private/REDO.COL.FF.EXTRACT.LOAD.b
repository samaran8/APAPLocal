...
*CALL APAP.TAM.REDO.CALL.COL.FF.EXTRACT.LOAD
    CALL APAP.TAM.redoCallColFfExtractLoad();* R22 Manual conversion - CALL method format changed
...
*CALL APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC)
        CALL APAP.REDOCHNLS.redoInterfaceRecAct(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC);* R22 Manual conversion - CALL method format changed
    END
RETURN
END
