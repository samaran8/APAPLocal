...
*CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.VALUE,Y.PREC.DEP.DAYS,PEN.AMT)
        CALL APAP.REDORETAIL.redoAzPenalAmtCalc(Y.VALUE,Y.PREC.DEP.DAYS,PEN.AMT);*MANUAL R22 CODE CONVERSION
...
*CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT)
    CALL APAP.REDORETAIL.redoAzPenalAmtCalc(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT);*MANUAL R22 CODE CONVERSION
    R.NEW(AZ.LOCAL.REF)<1,LOC.L.AZ.PENAL.AMT> = PEN.AMT
