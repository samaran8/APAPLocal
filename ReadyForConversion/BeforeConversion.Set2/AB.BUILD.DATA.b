...
*
    ...
    $INCLUDE T24.BP I_F.PGM.FILE
    $INCLUDE T24.BP I_F.STANDARD.SELECTION
*
    RTN.ERR = ""
    GOSUB INITIALISE ; IF RTN.ERR THEN GOTO EXIT
    GOSUB MAIN.PROCESSING ; IF RTN.ERR THEN GOTO EXIT
    PRINT
        ...
        IF SORT.LIST THEN
            ...
            FOR MY.CUR.ID.NUM = 1 TO COUNT.SORT.LIST
                ...
                IF MY.VAL THEN
                    ...
                    RTN.ERR = ""
                    GOSUB WRITE.TO.DISK ; IF RTN.ERR THEN RETURN
                END ELSE
...
*
    ...
    LIST.OF.FILES.BPS = ""
    RTN.ERR = ""
    GOSUB DEFINE.LIST.OF.FILES ; IF RTN.ERR THEN RETURN
    GOSUB DEFINE.LIST.OF.BPS ; IF RTN.ERR THEN RETURN
*
    FL.WRITE.SYSTEM.FLD = ""
*
