...
************
    ...
    END ELSE
        APOS = 1
    END
    IF APOS GT NEXT.DATE.NO THEN APOS = NEXT.DATE.NO
    NEXT.FREQ.BAL = STMT.BALS<APOS> + 0

    FOR I = APOS TO NEXT.DATE.NO
        ...
        IF NEXT.FREQ = '' THEN
            IF R.ACC.STMT THEN
                R.ACC.STMT<AC.STA.FQU1.LAST.DATE> = STMT.DATES<I>
