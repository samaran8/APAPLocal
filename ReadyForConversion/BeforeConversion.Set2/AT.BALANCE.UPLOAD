...
*
    ...
    WHILE MNE.COMP
        CALL F.READ(FN.MNEMONIC.COMPANY,MNE.COMP,R.MNEMONIC.COMPANY,F.MNEMONIC.COMPANY,ER.MNEMONIC.COMPANY)
        IF R.MNEMONIC.COMPANY<AC.MCO.COMPANY> THEN
            PRINT 'Processing branch---> ':MNE.COMP
            COMP.ID=R.MNEMONIC.COMPANY<AC.MCO.COMPANY>

            CALL F.READ(FN.COMPANY,COMP.ID,COMP.REC,F.COMPANY,COMP.ERR)
...
*Added by Muthamizh - s (HD0719013)
            CALL F.READ(FN.CURRENCY,AC.CYY,R.CCY,F.CURRENCY,CCY.ERR)
            IF R.CCY THEN
...
*Added by Muthamizh - E (HD0719013)
            ...
            CALL F.READ(FN.ACCT.GRP.CON,Y.AC.GRP.ID,R.AC.GRP.COND,F.ACCT.GRP.CON,ER.ACC.CON)
...
*   CONVERT FM TO LIN.FEED IN DETAIL.RECORD
    ...
    REPEAT
    CONVERT FM TO LIN.FEED IN INFO
