...
**GOSUB ACTUAL_PERIOD
        ...
        WHILE Y.STMT.ACC.ID DO
            ...
            FOR B = 1 TO Y.CAN.CR.INT.RATE STEP 1
                Y.TMP.CR.INT.RATE = Y.TMP.CR.INT.RATE + R.STMT<IC.STMCR.CR.INT.RATE, B>
            NEXT B
**MONTO GANADO:
            Y.CR.INT.AMT = R.STMT<IC.STMCR.CR.INT.AMT>
            Y.CAN.AMT = DCOUNT(Y.CR.INT.AMT,@VM)
            FOR I = 1 TO Y.CAN.AMT STEP 1
                Y.TMP.GANADO = Y.TMP.GANADO + R.STMT<IC.STMCR.CR.INT.AMT, I>
            NEXT I
            Y.TMP.TOTAL.GANADO = Y.TMP.TOTAL.GANADO + Y.TMP.GANADO

**MONTO RETENCION:
            Y.INT.TAX.AMT = R.STMT<IC.STMCR.CR.INT.TAX.AMT>
            Y.CAN.TAX.AMT = DCOUNT(Y.INT.TAX.AMT,@VM)
            FOR J = 1 TO Y.CAN.AMT STEP 1
                Y.TMP.RETENIDO = Y.TMP.RETENIDO + R.STMT<IC.STMCR.CR.INT.TAX.AMT, J>
            NEXT J
            Y.TMP.TOTAL.RETENIDO = Y.TMP.TOTAL.RETENIDO + Y.TMP.RETENIDO
...
**-------------------------------------------------------------------------------------------------
        ...
        Y.TOTAL.GANADO = Y.TOTAL.GANADO + Y.TMP.TOTAL.GANADO
        Y.TOTAL.RETENIDO = Y.TOTAL.RETENIDO + Y.TMP.TOTAL.RETENIDO
...
**MONTO GANADO:
        ...
        Y.CAN.AMT = DCOUNT(Y.CR.INT.AMT,@VM)
        FOR I = 1 TO Y.CAN.AMT STEP 1
            Y.TMP.GANADO.LQD = Y.TMP.GANADO.LQD + R.STMT<IC.STMCR.CR.INT.AMT, I>
        NEXT I
        Y.TMP.TOTAL.GANADO.LQD = Y.TMP.TOTAL.GANADO.LQD + Y.TMP.GANADO.LQD
...
**MONTO RETENCION:
        ...
        Y.CAN.TAX.AMT = DCOUNT(Y.INT.TAX.AMT,@VM)
        FOR J = 1 TO Y.CAN.AMT STEP 1
            Y.TMP.RETENIDO.LQD = Y.TMP.RETENIDO.LQD + R.STMT<IC.STMCR.CR.INT.TAX.AMT, J>
        NEXT J
        Y.TMP.TOTAL.RETENIDO.LQD = Y.TMP.TOTAL.RETENIDO.LQD + Y.TMP.RETENIDO.LQD

    REPEAT

    Y.TMP.TOTAL.GANADO = Y.TMP.TOTAL.GANADO + Y.TMP.TOTAL.GANADO.LQD
    Y.TMP.TOTAL.RETENIDO = Y.TMP.TOTAL.RETENIDO + Y.TMP.TOTAL.RETENIDO.LQD
...
**SI EL CLIENTE DE LA CUENTA X ES EL CLIENTE SOLICITADO EVALUO EVALUO SI LA CUENTA APLICA PARA MOSTRARSE
        IF T.CUSTOMER.ID EQ F.ID THEN
            ...
            Y.TOTAL.GANADO = Y.TOTAL.GANADO + T.MNT.ORI
            Y.TOTAL.RETENIDO = Y.TOTAL.RETENIDO + T.MNT.RET
            IF Y.TMP.TOTAL.GANADO NE 0 AND Y.TMP.TOTAL.RETENIDO NE 0 THEN
                IF T.AC.CATEGORY[1,2] NE "66" THEN
