...
*-----------------------------------------------------------------------------
    ...
    CALL REDO.GET.MARGIN.ID(Y.CAMP.TYPE,Y.AFF.COMP,R.ARRAY,Y.MARGIN.ID)
...
*------------------------------------------------------------------------------
    ...
    OFS.STRING.FINAL = ''
    CALL REDO.AA.BUILD.OFS(ARR.ID,R.INT.ARR.COND.OFS,Y.ACT.PROP,OFS.STRING.FINAL)
...
*-----------------------------------------------------------
    ...
    ERR.MSG = ''
    R.PENAL.COND = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENAL.COND,ERR.MSG)
    ...
    OFS.STRING.FINAL = ''
    CALL REDO.AA.BUILD.OFS(ARR.ID,R.PENAL.COND.OFS,Y.ACT.PROP,OFS.STRING.FINAL)
    OFS.SRC = 'AA.INT.UPDATE'
    OPTIONS = ''
    OFS.STRING.FINAL:="EFFECTIVE.DATE:1:1=":Y.CHECK.DATE
    CALL OFS.POST.MESSAGE(OFS.STRING.FINAL,OFS.MSG.ID,OFS.SRC,OPTIONS)
