...
***DEBUG
    ...
    Y.TYPE.CB = '';Y.CB.ACCOUN.TYPE = ''; Y.CNT = 0 ; I=''; J='' ; Y.DIFERENCIA.EB = 0
    IF R.CB THEN
        ...
        FOR J = 1 TO Y.CNT
            Y.CB.ACCOUN.TYPE = R.CB<ECB.TYPE.SYSDATE,J>
            FINDSTR Y.PENALIDAD IN Y.CB.ACCOUN.TYPE SETTING Ap, Vp THEN
                Y.TO.OPEN = R.CB<ECB.OPEN.BALANCE,J,1>
                Y.CREDIT.AMT = R.CB<ECB.CREDIT.MVMT,J,1>
                Y.DEBIT.AMT = R.CB<ECB.DEBIT.MVMT,J,1>
                Y.SUMA.AMT = Y.TO.OPEN + Y.CREDIT.AMT + Y.DEBIT.AMT
                Y.TOTAL.AMT = Y.TOTAL.AMT + Y.SUMA.AMT
...
GET.LECTURA.REGISTRO:
    ...
    Y.FINAL = Y.FINAL : Y.AA.RATE : CHAR(13)
