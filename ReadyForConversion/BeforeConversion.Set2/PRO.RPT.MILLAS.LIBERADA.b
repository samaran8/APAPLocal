...
**DEBUG
            ...
            FOR I = 1 TO Y.MV.CNT
                Y.SV.CNT = DCOUNT(R.LY<REDO.PT.PROGRAM,I>, @SM)
                FOR J = 1 TO Y.SV.CNT
                    Y.PROGRAM =  R.LY<REDO.PT.PROGRAM,I,J>
                    Y.STATUS =   R.LY<REDO.PT.STATUS,I,J>
                    Y.GEN.DATE = R.LY<REDO.PT.GEN.DATE,I,J>
                    Y.QUANTITY = R.LY<REDO.PT.QUANTITY,I,J>
                    Y.TXN.ID = R.LY<REDO.PT.TXN.ID,I,J>
...
*-----------------------------------------------------------
                        R.CT = ""; CT.ERROR = ""
                        CALL F.READ(FN.CT, Y.CATEGORY, R.CT, FV.CT, CT.ERROR)
...
*-----------------------------------------------------------
                        ...
                        CALL PRO.RPT.MILLAS.LIBERADA.MORA(Y.IN.AAR.ID, Y.IN.FT.ID, Y.OU.RETORNO)
                        ...
                        IF Y.OU.RETORNO EQ "NO" THEN
                            ...
                            Y.FINAL = Y.FINAL : Y.CAT.DESCRIPTION : CHAR(13)
