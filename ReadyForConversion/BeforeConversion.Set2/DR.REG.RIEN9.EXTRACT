...
*****************
    ...
    R.REDO.AA.SCHEDULE = ''; REDO.AA.SCHEDULE.ERR = ''; Y = 0
...
*************
    ...
    IF BILL.AMT EQ 0 OR NOT(BILL.AMT) THEN
        FMPOS1 = ''; VMPOS1 = ''; SMPOS1 = ''
        FINDSTR 'ACCOUNT' IN DUE.PRO<Y> SETTING FMPOS1,VMPOS1,SMPOS1 THEN
            BILL.AMT = TOT.PAY<Y,FMPOS1>
        END
        FMPOS1 = ''; VMPOS1 = ''; SMPOS1 = ''
        FINDSTR 'PRINCIPALINT' IN DUE.PRO<Y> SETTING FMPOS1,VMPOS1,SMPOS1 THEN
            BILL.AMT = TOT.PAY<Y,FMPOS1>
        END
    END
    RETURN
