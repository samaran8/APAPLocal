...
* PACS00244873 - S
  ...
  IF Y.FTCT.CT EQ "" THEN
    ETEXT = 'TT-REDO.FTCT.COMTX.FLG.MISS-&':FM:Y.LOC.APPL<2>
...
*
  ...
  CALL F.READ(FN.FTCT,Y.COMM.TAX.CODE,R.FTCT,F.FTCT,ERR.FTCT)
  IF R.FTCT THEN
...
*
  ...
  Y.LOC.APPL = "TELLER":FM:"FT.COMMISSION.TYPE"
