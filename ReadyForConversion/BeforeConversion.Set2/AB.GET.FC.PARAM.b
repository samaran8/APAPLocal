...
*
    ...
    IF C > 0 THEN COMMAND.FILE = COMMAND.LINE[C+1,LEN(COMMAND.LINE)-C]
...
*
    ...
    BATCH.JOB.COUNT = @SELECTED
    LOOP REMOVE CURRENT.FILE FROM ID.LIST SETTING D WHILE CURRENT.FILE:D
        FOR COMPANY.COUNT = 1 TO NUMBER.OF.COMPANIES
            ...
            IF R.FILE.CONTROL(EB.FILE.SYS.CLEAR.FILES) NE 'N' AND R.FILE.CONTROL(EB.FILE.SYS.CLEAR.FILES) THEN CONTINUE
            ...
            END
*
            IF MNEMONIC = '' THEN COMPANY.COUNT = NUMBER.OF.COMPANIES
