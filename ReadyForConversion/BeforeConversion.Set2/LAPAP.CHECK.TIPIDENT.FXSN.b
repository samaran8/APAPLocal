...
*------------------------------------------------------------------------------------
    ...
    $INCLUDE TAM.BP I_F.REDO.ID.CARD.CHECK
    $INCLUDE TAM.BP I_F.REDO.FXSN.TXN.VERSION
    $INCLUDE TAM.BP I_REDO.ID.CARD.CHECK.COMMON
...
**************************************
    ...
    THEN
        ...
        GOSUB PROCESS.INIT
    END
    ELSE IF Y.APPLICATION EQ 'TELLER'
    THEN
