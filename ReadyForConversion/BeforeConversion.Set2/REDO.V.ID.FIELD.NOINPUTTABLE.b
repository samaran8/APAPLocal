...
*------------------------------------------------------------------------------------------
    ...
    $INSERT TAM.BP I_F.REDO.BRANCH.STATUS
    ...
    $INSERT T24.BP  I_F.BROWSER.TOOLS
...
*-----
    ...
    Y.LOC.FIELDS = 'L.INITIAL.ID':VM:'L.NEXT.VERSION':VM:'L.TT.BEN.LIST':VM:'L.TT.BENEFICIAR':VM:'L.TT.CONCEPT':VM:'L.TT.CR.CARD.NO':VM:'L.TT.CLIENT.NME':VM:'L.TT.CLIENT.COD':FM:'L.INITIAL.ID':VM:'L.NEXT.VERSION':VM:'L.NO.OF.INSTAL':VM:'L.ADV.INS.CNT':VM:'L.AA.PART.ALLOW':VM:'CERT.CHEQUE.NO':VM:'L.COMMENTS'
