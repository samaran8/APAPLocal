...
READ.DATE:
    ...
    WHILE ID
        ...
        IF BATCH.STAGE[1,1] EQ 'A' AND NOT(APPL.ANALYSE) THEN
            APPL.ANALYSE='1'
            CRT 'Processing APPLICATION Stage....'
        END
        IF BATCH.STAGE[1,1] EQ 'S' AND NOT(SYS.ANALYSE) THEN
            SYS.ANALYSE='1'
        ...
        FOR I.VAR = 1 TO NO.JOBS
            ...
            IF JOB.LIST<1,I.VAR> EQ 'EB.CLEAR.FILES' THEN
