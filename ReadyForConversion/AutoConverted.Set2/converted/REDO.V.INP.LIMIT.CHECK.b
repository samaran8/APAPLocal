...
*
    R.TELLER.PARAMETER = ""
*
    CALL CACHE.READ(FN.TELLER.PARAMETER, TELL.ID, R.TELLER.PARAMETER, TELL.ERR)
...
*
    ...
    LOOP
*        I = 1
        LIMIT.DESGN = R.TELLER.PARAMETER<TT.PAR.LOCAL.REF><1,LOC.DESGN,I.VAR>
...
*
    ...
    TTTX.ERR             = ""
*
    CALL CACHE.READ(FN.TELLER.TRANSACTION, TTTX.ID, R.TELLER.TRANSACTION, TTTX.ERR)
