...
*
    ...
    FOR Y.CTR = 1 TO Y.COUNT
        IF R.NEW(ATM.BR.DEV.ID.CATEG)<1,Y.CTR> EQ '' AND R.NEW(ATM.BR.DEV.ID.AC.SUFX)<1,Y.CTR> EQ '' AND R.NEW(ATM.BR.DEV.ID.INT.ACCT)<1,Y.CTR> EQ '' THEN
        ...
        END ELSE
            IF R.NEW(ATM.BR.DEV.ID.INT.ACCT)<1,Y.CTR> EQ '' THEN
                IF R.NEW(ATM.BR.DEV.ID.CATEG)<1,Y.CTR> AND R.NEW(ATM.BR.DEV.ID.AC.SUFX)<1,Y.CTR> EQ '' THEN
                    AV = Y.CTR
                    AF = ATM.BR.DEV.ID.AC.SUFX
                    E = 'ENTER DEV.ID.AC.SUFX'
                END ELSE
                    IF R.NEW(ATM.BR.DEV.ID.CATEG)<1,Y.CTR> EQ '' AND R.NEW(ATM.BR.DEV.ID.AC.SUFX)<1,Y.CTR> THEN
                        AV = Y.CTR
                        AF = ATM.BR.DEV.ID.CATEG
    ...
    END
    FOR Y.CTR = 1 TO Y.COUNT
        IF R.NEW(ATM.BR.UTILITY.NAME)<1,Y.CTR> AND R.NEW(ATM.BR.UTIL.NO)<1,Y.CTR> EQ '' THEN
            AV = Y.CTR
            AF = ATM.BR.UTIL.NO
            E = 'INPUT MISSING'
        END ELSE
            IF R.NEW(ATM.BR.UTIL.NO)<1,Y.CTR> AND R.NEW(ATM.BR.UTILITY.NAME)<1,Y.CTR> EQ '' THEN
                AV = Y.CTR
