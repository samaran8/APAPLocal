...
* ======================
*
    CALL CACHE.READ(FN.TRANSACTION, WTR.CODE1, R.TRANSACTION, ERR.TRANS)
    IF NOT(R.TRANSACTION<AC.TRA.CHEQUE.IND>) THEN
        CALL CACHE.READ(FN.TRANSACTION, WTR.CODE2, R.TRANSACTION, ERR.TRANS)
        IF NOT(R.TRANSACTION<AC.TRA.CHEQUE.IND>) THEN
            PROCESS.GOAHEAD = ""
        END ELSE
    ...
    WHILE LOOP.CNT LE MAX.LOOPS AND PROCESS.GOAHEAD DO
        BEGIN CASE
            CASE LOOP.CNT EQ 1
                ...
                CALL CACHE.READ(FN.TELLER.TRANSACTION, WTTRAN.ID, R.TELLER.TRANSACTION, ERR.TTRAN)
