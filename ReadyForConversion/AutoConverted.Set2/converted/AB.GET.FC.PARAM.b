...
*
    ...
    BATCH.JOB.COUNT = @SELECTED
    LOOP REMOVE CURRENT.FILE FROM ID.LIST SETTING D.VAR WHILE CURRENT.FILE:D.VAR
...
*
    ...
    BEGIN CASE
        ...
        CASE FILE.CLASSIFICATION EQ "CST"
            ...
            END
        CASE FILE.CLASSIFICATION EQ "FTD"
