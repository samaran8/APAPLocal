...
GET_FIRST_COUNTRY:
    CALL CACHE.READ(FN.COU, T.TIT.NACIONALIDAD.1, R.COU, COU.ERR)
    T.COU.COUNTRY.NAME.1 = R.COU<EB.COU.COUNTRY.NAME>

RETURN

GET_SECOND_COUNTRY:
    CALL CACHE.READ(FN.COU, T.TIT.NACIONALIDAD.2, R.COU, COU.ERR)
...
GET_CO_CODE:
    CALL CACHE.READ(FN.COM, T.CO.CODE, R.COM, COM.ERR)
