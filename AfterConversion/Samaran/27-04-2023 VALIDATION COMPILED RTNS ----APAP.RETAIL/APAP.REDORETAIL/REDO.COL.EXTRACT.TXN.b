...
*CALL APAP.TAM.REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, Y.MAP.TYPE, Y.MAP.VALUE)
    CALL APAP.TAM.redoRColGetMapping(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, Y.MAP.TYPE, Y.MAP.VALUE);* R22 Manual conversion - CALL method format changed
    IF E THEN
        GOSUB TRACE.ERROR
    END
...
*CALL APAP.TAM.REDO.R.COL.PROCESS.TRACE(P.TYPE_PROC, P.STATUS.ERR, Y.CONTADOR, P.TABLE, Y.TYPE.TXN, C.DESC)
    CALL APAP.TAM.redoRColProcessTrace(P.TYPE_PROC, P.STATUS.ERR, Y.CONTADOR, P.TABLE, Y.TYPE.TXN, C.DESC);* R22 Manual conversion - CALL method format changed
*CALL APAP.TAM.REDO.R.COL.EXTRACT.ERROR(C.DESC, "REDO.COL.EXTRACT.TXN",P.TABLE)
    CALL APAP.TAM.redoRColExtractError(C.DESC, "REDO.COL.EXTRACT.TXN",P.TABLE);* R22 Manual conversion - CALL method format changed
*     C.MON.TP='08'
*     C.ID.PROC = REDO.INTERFACE.PARAM.ID
