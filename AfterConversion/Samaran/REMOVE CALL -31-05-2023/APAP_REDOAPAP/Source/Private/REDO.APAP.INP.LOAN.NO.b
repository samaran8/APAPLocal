* @ValidationCode : MjotNTI4MzQyNjgyOkNwMTI1MjoxNjg1NTMxMTQ1ODI4OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:35:45
...
*13-04-2023       AJITHKUMAR                  MANUAL R22 CODE CONVERSION CALL RTN FORMAT MODIFIED
*----------------------------------------------------------------------------------------
*********************************************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*PACS00054322 - S
    IF PGM.VERSION EQ ",DOC.MOVEMENT" THEN
        ...
        END
*CALL APAP.REDOAPAP.REDO.APAP.VAL.REASN.MVMT.M  ;*R22 MANUAL CODE CONVERSION
        APAP.REDOAPAP.redoApapValReasnMvmtM()  ;*R22 MANUAL CODE CONVERSION
* CALL APAP.REDOAPAP.REDO.APAP.VAL.DATE.MVMT.M   ;*R22 MANUAL CODE CONVERSION
        APAP.REDOAPAP.redoApapValDateMvmtM()  ;*R22 MANUAL CODE CONVERSION
    END
    IF PGM.VERSION EQ ",DOC.RECEPTION" THEN
*CALL APAP.REDOAPAP.REDO.APAP.V.RECEP.DATE   ;*R22 MANUAL CODE CONVERSION
        APAP.REDOAPAP.redoApapVRecepDate()  ;*R22 MANUAL CODE CONVERSION
*CALL APAP.REDOAPAP.REDO.APAP.VAL.REG.TITLE.DATE  ;*R22 MANUAL CODE CONVERSION
        APAP.REDOAPAP.redoApapValRegTitleDate()  ;*R22 MANUAL CODE CONVERSION
