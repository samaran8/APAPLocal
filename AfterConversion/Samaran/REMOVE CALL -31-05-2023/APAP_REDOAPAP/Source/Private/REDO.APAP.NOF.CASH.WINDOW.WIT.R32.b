* @ValidationCode : MjotMTg3MTM3ODEyMjpDcDEyNTI6MTY4NTUzMjE4MDI5MzpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 16:53:00
...
* CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.WIT.SAV.CUR.R32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR);*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowWitSavCurR32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)  ;*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
*****************
GET.SHORTAGE.AMT:
