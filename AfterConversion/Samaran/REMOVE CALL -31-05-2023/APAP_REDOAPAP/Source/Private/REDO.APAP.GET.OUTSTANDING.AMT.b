* @ValidationCode : MjoxMDM5MDk5NzkzOkNwMTI1MjoxNjg1NTMwNzc1Njk1OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:29:35
...
*--------------------------------------------------------------------------------------------------------
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    APAP.TAM.redoCrrGetConditions(ARRANGEMENT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)  ;*R22 MANUAL CODE CONVERSION
