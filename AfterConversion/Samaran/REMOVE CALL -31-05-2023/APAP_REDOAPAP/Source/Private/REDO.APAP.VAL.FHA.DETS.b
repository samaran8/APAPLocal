* @ValidationCode : MjoxNDU2NTkwODM3OkNwMTI1MjoxNjg1NTM3MDMxNDE5OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 18:13:51
...
* 06-04-2023          ANIL KUMAR B         R22 MANUAL CONVERSTION -CALL RTN FORMAT MODIFIED
*----------------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
******************
    ...
    R.AA.ARR.CHARGE = ''
    ERR.MSG = ''
    APAP.TAM.redoCrrGetConditions(AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.CHARGE,ERR.MSG) ;*R22 MANUAL CODE CONVERSION
RETURN
*------------------------------------------------------------------------------
*************************
READ.CPH.PARAMETER:
