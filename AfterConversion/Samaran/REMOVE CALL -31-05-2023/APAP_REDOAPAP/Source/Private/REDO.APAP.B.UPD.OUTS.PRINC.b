* @ValidationCode : MjoyMTQ4NDg5MzpDcDEyNTI6MTY4NTUzMDMzODE2MTpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 16:22:18
...
*-----------------------------------------------------------------------------
    ...
    Y.AMT=''
    APAP.REDOAPAP.redoApapGetOutstandingAmt(TODAY,ARR.ID,Y.AMT)   ;*R22 MANUAL CODE CONVERSION
    Y.AMT=ABS(Y.AMT)
