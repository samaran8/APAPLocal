* @ValidationCode : MjotMjYwNTkxNzkwOkNwMTI1MjoxNjg1NTM2MTUwNDg5OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:59:10
...
***********************
    ...
    IF R.REDO.APAP.MORTGAGES.DETAIL THEN
        ...
        REPEAT
    END
*CALL APAP.REDOAPAP.REDO.APAP.VAL.FHA.DETS  ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapValFhaDets() ;*R22 MANUAL CODE CONVERSION
RETURN
*---------------------------------------------------------------------------------------------------------------------------------
END
