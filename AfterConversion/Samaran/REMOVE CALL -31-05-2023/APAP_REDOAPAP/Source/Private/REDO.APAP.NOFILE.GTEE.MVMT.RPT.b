* @ValidationCode : MjoxODQ0MjYzMzA3OkNwMTI1MjoxNjg1NTMzMTM1OTY1OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:08:55
...
*PACS00180415-S
    ...
    R.AMT.CONDITION = ''
    ERR.AMT.MSG     = ''
    APAP.TAM.redoCrrGetConditions(ARR.AMT.ID,EFF.AMT.DATE,PROP.AMT.CLASS,PROPERTY.AMT,R.AMT.CONDITION,ERR.AMT.MSG) ;*R22 MANUAL CODE CONVERSION
...
*********************
    ...
    WHILE SEL.AA.ID:Y.AA.POS
        ...
        APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.ACCOUNT,ERR.MSG) ;*R22 MANUAL CODE CONVERSION
