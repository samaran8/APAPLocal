* @ValidationCode : MjoxNzIzMTYwNTAyOkNwMTI1MjoxNjg1NTMxMzA1Mzc4OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:38:25
...
*CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.SAV.CUR(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.COMPANY.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowDepSavCur(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.COMPANY.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
