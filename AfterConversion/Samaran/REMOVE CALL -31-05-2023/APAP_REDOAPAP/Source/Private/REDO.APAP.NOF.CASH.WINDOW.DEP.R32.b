* @ValidationCode : MjoxODQ3OTQ2Mzg4OkNwMTI1MjoxNjg1NTMxMzgzODM4OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:39:43
...
*CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.SAV.CUR.R32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.COMPANY.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR);*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowDepSavCurR32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.COMPANY.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
...
** consdiered for calculations and display
    ...
    APAP.REDOAPAP.redoApapNofCashWindowDepTermInstOpenR32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)  ;*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
****************
*GET.MTS.DETAILS:
