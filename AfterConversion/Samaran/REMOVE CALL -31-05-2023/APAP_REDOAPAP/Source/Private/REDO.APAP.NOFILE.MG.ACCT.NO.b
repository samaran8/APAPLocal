* @ValidationCode : Mjo1MzAxNjIxMTg6Q3AxMjUyOjE2ODU1MzMyOTc5Mzk6c2FtYXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 17:11:37
...
* CALL APAP.REDOAPAP.REDO.APAP.GET.OUTSTANDING.AMT(Y.MAT.DATE,Y.ARR.ID,Y.AMT) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapGetOutstandingAmt(Y.MAT.DATE,Y.ARR.ID,Y.AMT) ;*R22 MANUAL CODE CONVERSION
...
*CALL APAP.REDOAPAP.REDO.APAP.GET.MATURITY.AMT(Y.DEP.NO<1,VAR3>,MATURE.AMT) ;*R22 MANUAL CODE CONVERSION
        APAP.REDOAPAP.redoApapGetMaturityAmt(Y.DEP.NO<1,VAR3>,MATURE.AMT) ;*R22 MANUAL CODE CONVERSION
