* @ValidationCode : MjotMTEzODkzODk5OkNwMTI1MjoxNjg1NTM2NDQyNjI5OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 18:04:02
...
*----------------------------------------------------------
    ...
    WHILE Y.AGE.VAR LE Y.AGE.AA.CNT
        ...
        IN.ACC.ID  = ''
        Y.LOAN.ACC = ''
        APAP.TAM.redoConvertAccount(IN.ACC.ID,Y.AA.ID,Y.LOAN.ACC,ERR.TEXT) ;*R22 MANUAL CODE CONVERSION
