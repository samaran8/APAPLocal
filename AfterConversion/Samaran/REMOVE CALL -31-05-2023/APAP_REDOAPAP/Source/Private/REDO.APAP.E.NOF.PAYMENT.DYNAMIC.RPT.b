* @ValidationCode : MjotMTY0ODAwOTIxMjpDcDEyNTI6MTY4NTUzMDUyMzExMDpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 16:25:23
...
*12-04-2023       AJITHKUMAR                  MANUAL R22 CODE CONVERSION CALL RTN FORMAT MODIFIED
*----------------------------------------------------------------------------------------
...
*--------------------------------------------------------------------------------------------------------
    ...
    IF  Y.AGE.AA.IDS THEN
        ...
        APAP.REDOAPAP.redoApapENofPaymentDynamicRptGet(Y.AGE.AA.IDS,Y.OUT.ARRAY)  ;*R22 MANUAL CODE CONVERSION
