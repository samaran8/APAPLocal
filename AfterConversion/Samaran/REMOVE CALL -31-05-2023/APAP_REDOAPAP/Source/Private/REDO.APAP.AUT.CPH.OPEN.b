* @ValidationCode : MjotMjEwODU0OTQ1NjpDcDEyNTI6MTY4NTUzMDIzODMzODpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 16:20:38
...
*CALL APAP.REDOAPAP.REDO.APAP.GET.MATURITY.AMT(ID.NEW,Y.MAT.AMT)  ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapGetMaturityAmt(ID.NEW,Y.MAT.AMT)   ;*R22 MANUAL CODE CONVERSION
    ...
    LOOP
        ...
        GOSUB UPDATE.STATUS
*CALL APAP.REDOAPAP.REDO.APAP.GET.OUTSTANDING.AMT(TODAY,Y.ARR.ID,Y.OUTS.PRINCIPLE)  ;*R22 MANUAL CODE CONVERSION
        APAP.REDOAPAP.redoApapGetOutstandingAmt(TODAY,Y.ARR.ID,Y.OUTS.PRINCIPLE)   ;*R22 MANUAL CODE CONVERSION
