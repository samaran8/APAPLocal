* @ValidationCode : MjotMTg1NjAwNTQwNjpDcDEyNTI6MTY4NTUzMjU3MjQ5OTpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 16:59:32
...
*Y.CASH.EXCESS = Y.CASH.LIMIT - Y.CASH.HELD
    ...
    END
    APAP.TAM.redoRteExcessTeller(Y.TELLER.ID,Y.CURRENCY.ID,Y.AMT.EXCEEDED,REC.CNT)  ;*R22 MANUAL CODE CONVERSION
