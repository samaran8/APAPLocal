* @ValidationCode : MjoyMDU5NTk0Nzg4OkNwMTI1MjoxNjg1NTMwNjA3NjE4OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:26:47
...
*  CHANGE VM TO FM IN Y.OVERDUE.STATUS
    ...
    APAP.TAM.redoConvertAccount(IN.ACC.ID,ARR.ID,Y.ACCT.NO,ERR.TEXT)  ;*R22 MANUAL CODE CONVERSION
    Y.VAR1=1
    LOOP
...
* This part gets the Overdue Status of that Arrangement
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG)  ;*R22 MANUAL CODE CONVERSION
