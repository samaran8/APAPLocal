* @ValidationCode : Mjo4MjA4MDg0MjA6Q3AxMjUyOjE2ODU1MzIxMDU0NTI6c2FtYXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 16:51:45
...
GET.CASH.TELLER.TXN:
********************
*CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.WIT.CTT(Y.CCY.LIST,Y.AGENCY,Y.FINAL.ARRAY)  ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowWitCtt(Y.CCY.LIST,Y.AGENCY,Y.FINAL.ARRAY)  ;*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
***************************
...
*CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.WIT.SAV.CUR(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)  ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowWitSavCur(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)  ;*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
*****************
GET.SHORTAGE.AMT:
...
*CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.WIT.TEXT.R32(Y.CCY.LIST,Y.FINAL.ARRAY) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowWitTextR32(Y.CCY.LIST,Y.FINAL.ARRAY) ;*R22 MANUAL CODE CONVERSION
