* @ValidationCode : MjoxNzM4NjAzMTg5OkNwMTI1MjoxNjg1NTI4MjYxNDUzOnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 15:47:41
...
*CALL APAP.REDOAPAP.APAP.H.INS.BEHA.CHECK.RTN(CLASS.POLICY, POLICY.TYPE) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.apapHInsBehaCheckRtn(CLASS.POLICY, POLICY.TYPE) ;*R22 MANUAL CODE CONVERSION
    COMI=CLASS.POLICY
