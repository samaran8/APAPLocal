* @ValidationCode : MjoyMDI4NTQ3OTc1OkNwMTI1MjoxNjg1NTM0MjU4ODk1OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:27:38
...
*CALL APAP.REDOAPAP.REDO.APAP.REINV.VAL.FHA.DETS ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapReinvValFhaDets() ;*R22 MANUAL CODE CONVERSION
RETURN
*---------------------------------------------------------------------------------------------------------------------------------
END
