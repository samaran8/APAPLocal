* @ValidationCode : MjoyMDUzOTgzNDc2OkNwMTI1MjoxNjg1NTMyOTQwMjE1OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:05:40
...
*CALL APAP.REDOAPAP.REDO.APAP.NOFILE.CUS.CO.DET.GET.DET(Y.LOAN.ID,Y.ALT.ID,Y.LOAN.STATUS,Y.AMOUNT,Y.LIMIT.ID,Y.LIMIT.AMT,Y.OFFICER,Y.PDT.TYPE,Y.LOAN.NAME,Y.POL.TYPE,Y.CUS.ID,Y.PORTF.NO) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofileCusCoDetGetDet(Y.LOAN.ID,Y.ALT.ID,Y.LOAN.STATUS,Y.AMOUNT,Y.LIMIT.ID,Y.LIMIT.AMT,Y.OFFICER,Y.PDT.TYPE,Y.LOAN.NAME,Y.POL.TYPE,Y.CUS.ID,Y.PORTF.NO) ;*R22 MANUAL CODE CONVERSION
RETURN
*-------------------------------------------------------------------------------------------------------------------------------------------
***************
OUTGOING.ARRAY:
