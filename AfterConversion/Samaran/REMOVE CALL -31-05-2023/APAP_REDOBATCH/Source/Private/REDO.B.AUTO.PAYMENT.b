* @ValidationCode : MjoxMDgxNjYxOTM2OkNwMTI1MjoxNjg1NTM3MDg4ODU0OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 18:14:48
...
* CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PAYSCH.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PAYSCH.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
