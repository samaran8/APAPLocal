* @ValidationCode : MjoxNTc3NjQyODc3OkNwMTI1MjoxNjg1NTM4MTc1MjgxOnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 18:32:55
...
* Delete files of the enquieries
    APAP.REDOBATCH.redoCcrgBPopDel(P.IN.CUS.ID) ;*R22 MANUAL CODE CONVERSION
...
*  Report the error and take an action with the process
    ...
    APAP.REDOBATCH.redoCcrgBTraceError(R.SOURCE.INFO, R.MSG.ERR, @FALSE, P.IN.CUS.ID, @TRUE) ;*R22 MANUAL CODE CONVERSION
