* @ValidationCode : MjoyMTgxNTQ2NzA6Q3AxMjUyOjE2ODU1Mzc1MjAwMjU6c2FtYXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 18:22:00
...
*-----------------------------------------------------------------------------------------------
    ...
    EFF.DATE = ''
    Y.RES.FALG.UPD = ''
    APAP.TAM.redoCrrGetConditions(Y.ARRANGEMENT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG);*Manual R22 conversion
