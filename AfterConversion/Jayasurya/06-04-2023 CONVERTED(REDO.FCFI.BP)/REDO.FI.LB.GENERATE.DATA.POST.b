* @ValidationCode : Mjo4MTE1NDcwMjI6Q3AxMjUyOjE2ODA3NzE3OTcyOTc6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 06 Apr 2023 14:33:17
...
*
    IF Y.ERR NE "" THEN
        ...
        EX.USER = OPERATOR ;
        EX.PC = ''
        CALL APAP.REDOCHNSL.REDO.INTERFACE.REC.ACT(FI.INT.ACT.ID,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,ID.DESC,REC.CON,EX.USER,EX.PC) ;*MANUAL R22 CODE CONVERSION
