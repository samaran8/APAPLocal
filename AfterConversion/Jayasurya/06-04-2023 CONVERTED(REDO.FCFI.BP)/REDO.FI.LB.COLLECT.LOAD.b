* @ValidationCode : MjoxMjU5OTc3MzA4OkNwMTI1MjoxNjgwNzY5NDM0MzI4OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Apr 2023 13:53:54
...
* =================
    ...
    EX.USER = OPERATOR ;
    EX.PC = ''
    CALL APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(FI.INT.ACT.ID,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,ID.DESC,REC.CON,EX.USER,EX.PC) ;*MANUAL R22 CONVERSION
