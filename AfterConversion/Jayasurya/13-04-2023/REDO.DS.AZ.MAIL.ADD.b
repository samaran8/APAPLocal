* @ValidationCode : Mjo0OTkzOTAxOTg6Q3AxMjUyOjE2ODEzNzc3ODE3NTY6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Apr 2023 14:53:01
...
* Modification History:
* Date                 Who                              Reference                            DESCRIPTION
*13-04-2023           CONVERSION TOOL                AUTO R22 CODE CONVERSION                 VM TO @VM, FM TO @FM, F.READ TO CACHE.READ
...
* Forms the value of O.DATA by fetching necessary values from DE.ADDRESS
    ...
    CALL CACHE.READ(FN.DE.PRODUCT, Y.DE.ID, R.DE.PRODUCT.REC, DE.PRODUCT.ERR) ;*AUTO R22 CODE CONVERSION
    ...
    IF Y.PAIS NE '' THEN
        CALL CACHE.READ(FN.COUNTRY, Y.PAIS, R.COUNTRY, CTRY.ERR) ;*AUTO R22 CODE CONVERSION
