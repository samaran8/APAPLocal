* @ValidationCode : MjoyNzM3MTQwMTA6Q3AxMjUyOjE2ODExMTIwNDk1NzM6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 Apr 2023 13:04:09
...
* CHANGES END  HD1101263
    ...
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.VALIDATE.3 ;*MANUAL R22 CODE CONVERSION
...
************
    ...
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.VALIDATE.1 ;*MANUAL R22 CODE CONVERSION
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.VALIDATE.2 ;*MANUAL R22 CODE CONVERSION
