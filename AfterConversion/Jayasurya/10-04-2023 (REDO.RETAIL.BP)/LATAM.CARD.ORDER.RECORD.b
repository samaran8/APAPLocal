* @ValidationCode : Mjo1MTAwOTg0MjM6Q3AxMjUyOjE2ODExMTA4OTAxOTg6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 Apr 2023 12:44:50
...
************
    ...
    IF NOT(Y.PROCESS) AND Y.NEW.CARD THEN
        CALL REDO.DEFAULT.CHANNEL.ACCESS    ;* added to default channel exclusion ;*MANUAL R22 CODE CONVERSION
        Y.PROCESS=1
        Y.NEW.CARD=0
    END
