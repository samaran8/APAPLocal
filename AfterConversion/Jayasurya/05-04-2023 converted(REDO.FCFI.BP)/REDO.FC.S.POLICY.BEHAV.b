* @ValidationCode : MjotMzcwOTIzMTc1OkNwMTI1MjoxNjgwNjgyMzAzMzM0OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Apr 2023 13:41:43
...
* Apply behaviour
                    CALL APAP.REDOSRTN.REDO.FC.S.FIELD.VALID.POL(Y.FIELD.FROM, FIELD.BEHAVIOUR, FIELD.VALUE, Y.FIELD.FROM.NAME, I.VAR, J.VAR) ;* MANUAL R22 CODE CONVERSION
                END
            NEXT J.VAR
        END ELSE
            CALL APAP.REDOSRTN.REDO.FC.S.FIELD.VALID.POL(Y.FIELD.FROM, FIELD.BEHAVIOUR, FIELD.VALUE, Y.FIELD.FROM.NAME, I.VAR, '') ;* MANUAL R22 CODE CONVERSION
        END
