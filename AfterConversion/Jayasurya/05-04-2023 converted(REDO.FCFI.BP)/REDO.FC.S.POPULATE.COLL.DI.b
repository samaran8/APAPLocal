* @ValidationCode : MjotMjY1MDE4MTcyOkNwMTI1MjoxNjgwNjg3OTUwMzk1OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Apr 2023 15:15:50
...
* Call routine to populate COLLATERAL.RIGHT
    CALL APAP.REDOSRTN.REDO.FC.S.POP.COLL.RIGHT(Y.SEC.NO, Y.I) ;*MANUAL R22 CODE CONVERSION
RETURN
*------------------------------------------------------------------------------------------------------------------
GET.LOCAL.FIELD:
*------------------------------------------------------------------------------------------------------------------
...
* Getting current AA Balance value
    ...
    Y.AA.BAL = AA.ARR
    CALL APAP.AA.REDO.S.FC.AA.BAL(Y.AA.ID, Y.AA.BAL) ;*MANUAL R22 CODE CONVERSION
