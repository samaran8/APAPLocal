* @ValidationCode : MjotMTc3NjE2NTUwMzpDcDEyNTI6MTY4MjU4MDg5NDc4OTpJVFNTQk5HOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:04:54
...
*CALL APAP.REDOSRTN.REDO.S.BY.EVENT(EVENT,ACCT.ID,R.ACCOUNT,CHK.VAL,ANTIG) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.REDOSRTN.redoSByEvent(EVENT,ACCT.ID,R.ACCOUNT,CHK.VAL,ANTIG) ;* MANUAL R22 CODE CONVERSION
    IF CHK.VAL THEN
        GOSUB CHECK.PT.GEN
    END
