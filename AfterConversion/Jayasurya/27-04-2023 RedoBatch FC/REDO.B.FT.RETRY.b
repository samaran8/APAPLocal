* @ValidationCode : MjotMTEyNjgwNzI1MDpDcDEyNTI6MTY4MjU3Nzc4NDY5MDpJVFNTQk5HOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 12:13:04
...
*CALL APAP.TAM.REDO.U.NEW.FT.IN.HOLD(ARR.ID,FT.ID,R.FUNDS.TRANSFER,R.STO) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoUNewFtInHold(ARR.ID,FT.ID,R.FUNDS.TRANSFER,R.STO) ;* MANUAL R22 CODE CONVERSION
RETURN
