* @ValidationCode : MjoyMDI3ODcyMDAxOkNwMTI1MjoxNjgyNTc4NDQyMjk2OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 12:24:02
...
* CALL APAP.TAM.REDO.UPLOAD.DEBIT.ACCOUNT.CHECK(Y.FILE.DEB.ACCT,Y.DR.ACCT.STATUS) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoUploadDebitAccountCheck(Y.FILE.DEB.ACCT,Y.DR.ACCT.STATUS) ;* MANUAL R22 CODE CONVERSION
