* @ValidationCode : MjoyMzg1MjczOTg6Q3AxMjUyOjE2ODI1ODU2OTYzMTY6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 14:24:56
...
*
    ...
    Y.REL.REQ = ''
    OUT.ARR = ''
* CALL APAP.REDOSRTN.REDO.S.REP.CUSTOMER.EXTRACT(Y.CUSTOMER,Y.PROG.GRP,Y.REL.REQ,OUT.ARR) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.REDOSRTN.redoSRepCustomerExtract(Y.CUSTOMER,Y.PROG.GRP,Y.REL.REQ,OUT.ARR) ;*MANUAL R22 CODE CONVERSION
