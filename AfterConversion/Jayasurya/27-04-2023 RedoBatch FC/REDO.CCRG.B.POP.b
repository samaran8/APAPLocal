* @ValidationCode : MjotMTc3NDIwMDc3MDpDcDEyNTI6MTY4MjU5MTg2OTM1MzpJVFNTQk5HOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 16:07:49
...
*CALL APAP.REDOBATCH.REDO.CCRG.B.POP.DEL(P.IN.CUS.ID) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.REDOBATCH.redoCcrgBPopDel(P.IN.CUS.ID) ;*MANUAL R22 CODE CONVERSION
...
* CALL APAP.REDOBATCH.REDO.CCRG.B.TRACE.ERROR(R.SOURCE.INFO, R.MSG.ERR, @FALSE, P.IN.CUS.ID, @TRUE) ;*R22 MANUAL CONVERSTION ADD PACKAGE
    CALL APAP.REDOBATCH.RedoCcrgBTraceError(R.SOURCE.INFO, R.MSG.ERR, @FALSE, P.IN.CUS.ID, @TRUE) ;*R22 MANUAL CONVERSTION ADD PACKAGE
*
RETURN
*-----------------------------------------------------------------------------
