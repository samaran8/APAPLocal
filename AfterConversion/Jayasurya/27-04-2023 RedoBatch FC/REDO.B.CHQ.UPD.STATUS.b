* @ValidationCode : Mjo5ODkxNTkxNjQ6Q3AxMjUyOjE2ODI1MTI3NTY5ODk6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:09:16
...
*--------------
    ...
    IF R.REDO.LOAN.CHQ.RETURN<LN.CQ.RET.NO.OF.RET.CHQ> LT Y.MAX.RETURN.CHQ THEN
        IN.ARR.ID = ''
        OUT.ID = ''
*CALL APAP.TAM.REDO.CONVERT.ACCOUNT(Y.LOAN.NO,IN.ARR.ID,OUT.ID,ERR.TEXT) ;* MANUAL R22 CODE CONVERSION
        CALL APAP.TAM.redoConvertAccount(Y.LOAN.NO,IN.ARR.ID,OUT.ID,ERR.TEXT) ;* MANUAL R22 CODE CONVERSION
        ARR.ID = OUT.ID
