* @ValidationCode : Mjo3MzQ4NDQ0MjA6Q3AxMjUyOjE2ODI1OTAzMDY3ODI6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 15:41:46
...
* CALL APAP.TAM.REDO.GET.POOL.RATE(AZ.CUR,Y.DIFF.DAYS,RATE);*Manual R22 conversion
    CALL APAP.TAM.redoCrrGetConditions(AZ.CUR,Y.DIFF.DAYS,RATE);*Manual R22 conversion
    BUY.RATE = RATE<2>
