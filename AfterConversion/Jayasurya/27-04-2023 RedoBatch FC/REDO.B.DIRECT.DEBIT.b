* @ValidationCode : Mjo5ODExODQ4NTA6Q3AxMjUyOjE2ODI1NzYxODAwOTI6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 11:46:20
...
*----------------------
    ...
    ERR.MSG = ''
    R.INT.ARR.COND = ''
* CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.ARR.COND,ERR.MSG) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.ARR.COND,ERR.MSG) ;* MANUAL R22 CODE CONVERSION
