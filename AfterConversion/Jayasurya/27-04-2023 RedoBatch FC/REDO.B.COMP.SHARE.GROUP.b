* @ValidationCode : MjotMTc4NTI2OTQ4NTpDcDEyNTI6MTY4MjU3NDc3ODYzNjpJVFNTQk5HOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 11:22:58
...
**
    ...
    PRODUCT.GROUP = ''
    REL.CODE      = ''
* CALL APAP.REDOSRTN.REDO.S.REP.CUSTOMER.EXTRACT(SL.CUSTOMER.ID,PRODUCT.GROUP,REL.CODE,OUT.ARR) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.REDOSRTN.redoSRepCustomerExtract(SL.CUSTOMER.ID,PRODUCT.GROUP,REL.CODE,OUT.ARR) ;* MANUAL R22 CODE CONVERSION
