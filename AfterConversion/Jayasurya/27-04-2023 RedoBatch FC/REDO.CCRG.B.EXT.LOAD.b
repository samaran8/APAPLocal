* @ValidationCode : MjotMTM5OTU4MDI0OkNwMTI1MjoxNjgyNTkxNzY3MzE1OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 16:06:07
...
*CALL APAP.REDOBATCH.REDO.CCRG.B.TRACE.ERROR('REDO.CCRG.B.EXT.LOAD', Y.ERROR, @FALSE, "", @FALSE) ;*R22 MANUAL CONVERSTION ADD PACKAGE
        CALL APAP.REDOBATCH.RedoCcrgBTraceError('REDO.CCRG.B.EXT.LOAD', Y.ERROR, @FALSE, "", @FALSE) ;*R22 MANUAL CONVERSTION ADD PACKAGE
    END
