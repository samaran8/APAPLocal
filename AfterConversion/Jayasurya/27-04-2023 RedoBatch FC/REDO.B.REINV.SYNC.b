* @ValidationCode : MjoxMDUzNjA3MjEzOkNwMTI1MjoxNjgyNDkxNTc3Mjk5OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 12:16:17
...
*---------------------------------------------------------------------------------
    ...
    IF Y.MATURITY.DATE GT TODAY AND Y.MATURITY.DATE LT Y.NEXT.WORKING.DAY THEN
        ...
        IF YDAY.TYPE NE 'W' THEN
            CALL APAP.REDORETAIL.REDO.ACI.AZ.INT.RATE(Y.AZ.ACCOUNT.ID,Y.ACI.OFS.ARRAY,Y.MATURITY.DATE,VAR.INT.RATE) ;*MANUAL R22 CODE CONVERSION
        END
    END
