* @ValidationCode : MjoxMTU4OTgxNjE2OkNwMTI1MjoxNjgyNDg4NTEyMDA3OklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 11:25:12
...
*-------------------
    ...
    IF NEXT.MONTH NE CUR.MONTH THEN
        CALL APAP.REDOSRTN.REDO.S.BY.MTH.INC.AVG.BAL(ACCT.ID,CHK.VAL) ;*MANUAL R22 CODE CONVERSION
    END
...
*-----------
    ...
    IF NEXT.MONTH NE CUR.MONTH THEN
        CALL APAP.REDOSRTN.REDO.S.BY.MTH.INT(ACCT.ID,CHK.VAL) ;*MANUAL R22 CODE CONVERSION
    END
