* @ValidationCode : MjoxNTYwNTM4MDI6Q3AxMjUyOjE2ODI1NzU4ODY0OTE6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 11:41:26
...
*CALL APAP.TAM.REDO.GET.DISBURSEMENT.DETAILS(Y.IDS.DETAILS,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB) ;*R22 MANUAL CODE CONVERSION     ;* Get the disb amount.
    CALL APAP.TAM.redoGetDisbursementDetails(Y.IDS.DETAILS,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB) ;*R22 MANUAL CODE CONVERSION     ;* Get the disb amount.
...
*CALL APAP.TAM.REDO.GET.TOTAL.OUTSTANDING.BYPROP(Y.AA.ID,Y.ACC.PROPERTY,Y.BALANCE.TYPE,Y.AMT) ;* MAUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoGetTotalOutstandingByprop(Y.AA.ID,Y.ACC.PROPERTY,Y.BALANCE.TYPE,Y.AMT) ;* MAUAL R22 CODE CONVERSION
...
*CALL APAP.TAM.REDO.GET.TOTAL.OUTSTANDING.BYPROP(Y.AA.ID,Y.INT.PROPERTY,Y.BALANCE.TYPE,Y.AMT) ;* MAUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoGetTotalOutstandingByprop(Y.AA.ID,Y.INT.PROPERTY,Y.BALANCE.TYPE,Y.AMT) ;* MAUAL R22 CODE CONVERSION
