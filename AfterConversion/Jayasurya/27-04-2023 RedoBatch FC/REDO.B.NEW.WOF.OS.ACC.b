* @ValidationCode : MjotMTIyODU1MTkyNDpDcDEyNTI6MTY4MjU4NDMzMzI2MzpJVFNTQk5HOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 14:02:13
...
*------------------------------------------------------------
    ...
    R.CONDITION.OVERDUE = ''
    ERR.MSG = ''; Y.BILL.TYPE = ''
*CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoCrrGetConditions(Y.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG) ;* MANUAL R22 CODE CONVERSION
