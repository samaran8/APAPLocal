* @ValidationCode : MjoxMjA5NDI5MTk5OkNwMTI1MjoxNjgyNTE0ODA5ODgwOklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:43:29
...
* CALL APAP.TAM.REDO.RPT.CLSE.WRITE.LOANS(AA.ARR.ID,R.ARR.APPL,ARRAY.VAL) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoRptClseWriteLoans(AA.ARR.ID,R.ARR.APPL,ARRAY.VAL) ;* MANUAL R22 CODE CONVERSION
...
*CALL APAP.REDOSRTN.REDO.S.REP.CUSTOMER.EXTRACT(Y.AA.CUS.ID,Y.MAIN.PROD.GROUP,Y.REL.CODE,OUT.ARR) ;* MANUAL R22 CODE CONVERSION
    CALL APAP.REDOSRTN.redoSRepCustomerExtract(Y.AA.CUS.ID,Y.MAIN.PROD.GROUP,Y.REL.CODE,OUT.ARR) ;* MANUAL R22 CODE CONVERSION
