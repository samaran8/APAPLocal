* @ValidationCode : MjoxOTYyNzQwOTY6Q3AxMjUyOjE2ODExOTk1MDUwNDU6SVRTU0JORzotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Apr 2023 13:21:45
...
* PACS00736522 - E
    ...
    END
    Y.PEN.PERCENT=COMI
    CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.PEN.PERCENT,Y.PREC.DEP.DAYS,PEN.AMT)  ;*MANUAL R22 CODE CONVERSION
