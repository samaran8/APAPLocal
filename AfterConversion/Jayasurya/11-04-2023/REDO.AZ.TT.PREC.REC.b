* @ValidationCode : MjotMjY4ODY5MTQwOkNwMTI1MjoxNjgxMjA1NzQ4MDYxOklUU1NCTkc6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Apr 2023 15:05:48
...
* This part raises a penalty for preclosure before maturity(Deposit Not Rolled Over)
    ...
    END ELSE
        ...
        CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC('0',Y.PREC.DEP.DAYS,PEN.AMT) ;*MANUAL R22 CONVERSION
...
********************
    ...
    CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT) ;*MANUAL R22 CONVERSION
    R.NEW(TT.TE.LOCAL.REF)<1,LOC.L.TT.PENAL.AMT> =PEN.AMT
