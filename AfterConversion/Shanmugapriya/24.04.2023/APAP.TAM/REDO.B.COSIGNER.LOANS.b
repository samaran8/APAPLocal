* @ValidationCode : MjotMTg2NDIxMjQwNTpDcDEyNTI6MTY4MjMxNTU4MjI4MDpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 24 Apr 2023 11:23:02
...
** R22 Manual conversion
    CALL APAP.TAM.REDO.RPT.CLSE.WRITE.LOANS(Y.AA.ARR.ID,R.ARRANGEMENT,ARRAY.VAL)
...
** R22 Manual conversion
    CALL APAP.TAM.REDO.RPT.ACCT.ALT.LOANS(YACCT.GRP,Y.PREV.ACCOUNT)
...
** R22 Manual conversion
    CALL APAP.LAPAP.REDO.S.REG.CUSTOMER.EXTRACT(Y.CUSTOMER.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR)
