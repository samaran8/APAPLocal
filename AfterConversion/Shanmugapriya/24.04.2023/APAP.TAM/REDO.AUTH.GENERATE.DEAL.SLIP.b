* @ValidationCode : MjoxMzkxMTc0OTEzOkNwMTI1MjoxNjgyMzEzMTA0NzIzOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 24 Apr 2023 10:41:44
...
** R22 Manual conversion
    CALL APAP.REDORETAIL.REDO.CUST.IDENTITY.REF(Y.CUST.ID,Y.ALT.ID,Y.CUS.NAME)
...
** R22 Manual conversion
    CALL APAP.TAM.REDO.CONVERT.ACCOUNT(Y.LOAN.ACC,IN.ARR.ID,ARR.ID,ERR.TEXT)
*CALL REDO.GET.INDV.REPAY.AMT(Y.AA.PAYMENT.TXNS<Y.VAR2>,ARR.ID,TOTAL.AMT,Y.BILL.PAY.DATE)
** R22 Manual conversion
    CALL APAP.TAM.REDO.GET.INDV.REPAY.AMT(Y.AA.PAYMENT.TXNS<Y.VAR2>,ARR.ID,TOTAL.AMT,Y.BILL.PAY.DATE)
...
** R22 Manual conversion
    CALL APAP.TAM.REDO.GET.PROPERTY.NAME(ARR.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)
