* @ValidationCode : MjotMTUzMTk4MzU5MTpDcDEyNTI6MTY4MjMxNDA3MzM5MjpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 24 Apr 2023 10:57:53
...
* 24.04.2023       Conversion Tool       R22            Auto Conversion     - INSERT file folder name removed T24.BP,LAPAP.BP & TAM.BP, FM TO @FM, VM TO @VM, SM TO @SM, F TO CACHE
...
*
    $INSERT I_F.REDO.H.REPORTS.PARAM                             ;** R22 Auto Conversion - Start
    $INSERT I_REDO.GENERIC.FIELD.POS.COMMON
    $INSERT I_REDO.B.CON.LNS.BY.DEBTOR.COMMON
    $INSERT I_F.REDO.APAP.PROPERTY.PARAM                           ;** R22 Auto Conversion - End
*
...
*
    CALL CACHE.READ(FN.AA.PRODUCT.GROUP, Y.PRODUCT.GROUP, R.AA.PRODUCT.GROUP, AA.PRD.GRP.ERR)               ;** R22 Auto conversion - F TO CACHE
