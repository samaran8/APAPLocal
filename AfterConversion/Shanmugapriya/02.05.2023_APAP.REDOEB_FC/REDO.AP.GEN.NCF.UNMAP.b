* @ValidationCode : MjotMjI0ODU5NzYyOkNwMTI1MjoxNjgzMDQ5MzEyNjY1OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 02 May 2023 23:11:52
...
*CALL REDO.STO.NCF.UPDATE(VAR.NCF.REQ,VAR.CURRENCY,VAR.CHARGE.AMOUNT,VAR.TAX.AMOUNT)
            CALL APAP.TAM.redoStoNcfUpdate(VAR.NCF.REQ,VAR.CURRENCY,VAR.CHARGE.AMOUNT,VAR.TAX.AMOUNT) ;*Manual R22 conversion
...
*CALL REDO.NCF.PERF.RTN(Y.CNT,Y.NCF.NO.LIST)
    CALL APAP.TAM.redoNcfPerfRtn(Y.CNT,Y.NCF.NO.LIST) ;*Manual R22 conversion
