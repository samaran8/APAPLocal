* @ValidationCode : MjoxMDA3NjA3MzIxOkNwMTI1MjoxNjgzMDE4MTAyMzE3OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* CALL REDO.S.CUST.ID.VAL(CUST.ID,CUST.NO,CUS.ERR)
    CALL APAP.TAM.redoSCustIdVal(CUST.ID,CUST.NO,CUS.ERR)    ;*R22 MANUAL CODE CONVERSION
