* @ValidationCode : MjotMTg0NjMxMTU3NTpDcDEyNTI6MTY4MzAxODA5NjgxODpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*CALL REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.Condition,ERR.MSG)
        CALL APAP.TAM.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.Condition,ERR.MSG) ;* R22 Manual conversion
