* @ValidationCode : MjoxMDU5NjU3NTY3OkNwMTI1MjoxNjgwNjU4NDQ3MzYyOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
GET.PREVIOUS.LOAN.STATUS:
    ...
    CALL APAP.TAM.REDO.GET.OVERDUE.POSITION(ARR.ID,PREV.LOAN.STATUS, PREV.POS, OD.COUNT)   ;* Get the Previous OD postion
...
GET.CURRENT.LOAN.STATUS:
    ...
    CALL APAP.TAM.REDO.GET.OVERDUE.POSITION(ARR.ID, CURRENT.LOAN.STATUS, CUR.POS, OD.COUNT)          ;*Get the Current OD postion
