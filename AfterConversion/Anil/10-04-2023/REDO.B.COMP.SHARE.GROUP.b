* @ValidationCode : MjotMTUzMTQwOTk1OTpDcDEyNTI6MTY4MTEwOTcwOTk2MjpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Apr 2023 12:25:09
...
* Include files
*-----------------------------------------------------------------------------------------------------------------
    $INSERT I_TSA.COMMON 	;*R22 AUTO I_COMMON TO I_TSA.COMMON
    $INSERT I_COMMON
    $INSERT I_EQUATE
