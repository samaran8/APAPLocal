* @ValidationCode : MjotOTQ5NDg4OTYwOkNwMTI1MjoxNjgzMTAwMDc1MDIxOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 13:17:55
...
*---------------
    ACC = ID
    CALL APAP.LAPAP.lapapVerifyAcc(ACC,RES)
    Y.ACC.ID = RES
