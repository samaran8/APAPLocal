* @ValidationCode : MjoxNzM4Nzk4MjY1OkNwMTI1MjoxNjgyNDE3NTQyMDA3OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Apr 2023 15:42:22
...
*JSON ESCAPE CHARATERS
        ...
        BEGIN CASE
            ...
            CASE COUNT(Y.ITEM.VALUE,@SM) GT 0
                CALL APAP.LAPAP.L.APAP.SM.TO.JSON.ARRAY(Y.ITEM.VALUE, Y.JSON.ITEM) ;*R22 Manual conversion adding package
                Y.JSON.ITEM = QUOTE(Y.ITEM.KEY) : ':' : Y.JSON.ITEM
            CASE COUNT(Y.ITEM.VALUE,@VM) GT 0
                CALL APAP.LAPAP.L.APAP.VM.TO.JSON.ARRAY(Y.ITEM.VALUE, Y.JSON.ITEM) ;*R22 Manual conversion adding package
                Y.JSON.ITEM = QUOTE(Y.ITEM.KEY) : ':' : Y.JSON.ITEM
            CASE 1
