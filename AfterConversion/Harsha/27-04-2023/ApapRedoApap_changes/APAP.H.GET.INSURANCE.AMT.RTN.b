* @ValidationCode : MjoyMTI3OTc5NDMwOkNwMTI1MjoxNjgyNDIzMTc4ODY4OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Apr 2023 17:16:18
...
*================
    ...
    FOR ITR = 1 TO NO.OF.BEHA
        ...
        CALL APAP.REDOAPAP.APAP.H.GET.COLL.AMT.RTN(FIELD.VALUE, AMOUNT, R.BEHA.FLDS, FIELD.NAME)
    NEXT
...
*R.NEW(FIELD.NO)=''
                ...
                CALL APAP.REDOAPAP.APAP.H.GET.COLL.AMT.RTN(FIELD.VALUE, POL.EXP.DATE.VALUE,R.BEHA.FLDS, FIELD.NAME)
