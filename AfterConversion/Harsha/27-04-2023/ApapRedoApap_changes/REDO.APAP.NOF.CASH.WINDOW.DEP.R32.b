* @ValidationCode : MjotMjA3NDY2NzExNzpDcDEyNTI6MTY4MjQyNDY1MjUxMTpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 25 Apr 2023 17:40:52
...
** consdiered for calculations and display
    ...
    CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.TERM.INST.OPEN.R32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)
RETURN
*--------------------------------------------------------------------------------------------------------
****************
*GET.MTS.DETAILS:
