* @ValidationCode : Mjo2OTAyOTYxNjQ6Q3AxMjUyOjE2ODI0MjU0MDIzOTA6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 25 Apr 2023 17:53:22
...
** withdrawals details
    LOCATE TELLER.ID IN Y.TT.LIST<1> SETTING Y.TT.POS THEN
        RETURN
    END
    CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.WIT.TERM.INST.INT.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.CASH.CATEG,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
RETURN
*--------------------------------------------------------------------------------------------------------
********************************
...
* In this para of the code, a CALL to a seperate routine is made to fetch the CASH TRANSFERS TO TELLER details
    ...
    CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.WIT.CTT.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
    TELLER.ID = YTELLER.ID
RETURN
*--------------------------------------------------------------------------------------------------------
*****************
