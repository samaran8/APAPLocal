* @ValidationCode : MjotMjcyODkwMDQzOkNwMTI1MjoxNjgyNDI0MDE5NTQ0OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Apr 2023 17:30:19
...
*-----------------------------------------------------------------------------
    ...
    Y.AMT=''
    CALL APAP.REDOAPAP.REDO.APAP.GET.OUTSTANDING.AMT(TODAY,ARR.ID,Y.AMT)
    Y.AMT=ABS(Y.AMT)
