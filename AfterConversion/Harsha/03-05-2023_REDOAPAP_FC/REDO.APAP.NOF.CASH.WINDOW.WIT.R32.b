...
** consdiered or not for calculations and display
    ...
    CALL APAP.REDOAPAP.redoApapNofCashWindowWitSavCurR32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR);*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
*****************
GET.SHORTAGE.AMT:
...
* In this para of the code, a CALL is made to an routine to add the static text in the report for display
    CALL APAP.REDOAPAP.redoApapNofCashWindowWitTextR32(Y.CCY.LIST,Y.FINAL.ARRAY) ;*R22 AUTO CODE CONVRSION
