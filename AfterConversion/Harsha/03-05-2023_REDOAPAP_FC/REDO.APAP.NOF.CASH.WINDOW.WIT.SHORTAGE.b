* @ValidationCode : Mjo0NzU4NTEyNjk6Q3AxMjUyOjE2ODI1MDI2NTgwMzI6SVRTUzotMTotMTo5Nzg6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Apr 2023 15:20:58
...
* Date                   who                   Reference
* 06-04-2023         CONVERSTION TOOL     R22 AUTO CONVERSTION FM TO @FM AND F.READ TO CACHE.READ AND REMOVED F.TELLER.PARAMETER
...
* In this para of the code, file TELLER.PARAMETER is read
    ...
    TELLER.PARAMETER.ER = ''
*TUS Start
    CALL CACHE.READ(FN.TELLER.PARAMETER, TELLER.PARAMETER.ID, R.TELLER.PARAMETER, TELLER.PARAMETER.ER) ;*R22 AUTO CONVERSTION F.READ TO CACHE.READ AND REMOVED F.TELLER.PARAMETER
