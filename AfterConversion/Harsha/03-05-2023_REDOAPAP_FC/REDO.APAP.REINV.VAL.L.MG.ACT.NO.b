* @ValidationCode : MjoyMTEzMzgwNjM0OkNwMTI1MjoxNjgyNTAyNjY1MjQ3OklUU1M6LTE6LTE6NjE6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
**********
    ...
    END ELSE
        ...
        END
    END
    CALL APAP.REDOAPAP.redoApapReinvValFhaDets() ;*R22 MANUAL CODE CONVERSION
RETURN
*---------------------------------------------------------------------------------------------------------------------------------
END
