* @ValidationCode : MjotMTA1NjEwODYxNTpDcDEyNTI6MTY4MjUwMjY2MTQzODpJVFNTOi0xOi0xOjIzOTY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Apr 2023 15:21:01
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2396
...
*---------------------------------------------------------------------------------------
*DATE               WHO                       REFERENCE                 DESCRIPTION
*17-04-2023       CONVERSION TOOLS            AUTO R22 CODE CONVERSION  FM to @FM , VM to @VM ,= to EQ,CONVERT into CHANGE .SM to @SM
...
*  Y.COL.ID = R.AC.COLL<1>
    ...
    CHANGE @VM TO @FM IN Y.COL.ID ;*R22 AUTO CODE CONVERSION
*TUS End
