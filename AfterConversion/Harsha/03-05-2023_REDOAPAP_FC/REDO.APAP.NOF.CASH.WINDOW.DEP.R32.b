* @ValidationCode : MjotOTgzMDA0MTMxOkNwMTI1MjoxNjgzMTEzNjMwNzg3OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 17:03:50
...
** consdiered or not for calculations and display
    ...
    CALL APAP.REDOAPAP.redoApapNofCashWindowDepSavCurR32(Y.CCY.LIST,R.REDO.H.TELLER.TXN.CODES,Y.COMPANY.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR);*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
***************************
