* @ValidationCode : MjoxNDg2NjYzOTQ5OkNwMTI1MjoxNjgyNDI1MjA3MzU4OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Apr 2023 17:50:07
...
* In this para of the code, a CALL is made to an routine to add the static text in the report for display
    ...
    CALL APAP.REDOAPAP.redoApapNofCashWindowWitTextR32(Y.CCY.LIST,Y.FINAL.ARRAY) ;*R22 MANUAL CODE CONVERSION
