* @ValidationCode : MjotMTI2NTQ4MDIxNTpDcDEyNTI6MTY4MjU3MzQ2MDczOTpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 11:01:00
...
****************
    ...
    Y.FT.OUT.LIST=''
    CALL APAP.REDOAPAP.REDO.APAP.SAP.GL.DETAIL.RPT.SPLIT.1(Y.RE.CONSOL.SPEC.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    GOSUB WRITE.DATA.TO.SESSION.FILES
...
*****************
    ...
    Y.FT.OUT.LIST=''
    CALL APAP.REDOAPAP.REDO.APAP.SAP.GL.DETAIL.RPT.SPLIT.1(Y.CATEG.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    GOSUB WRITE.DATA.TO.SESSION.FILES
