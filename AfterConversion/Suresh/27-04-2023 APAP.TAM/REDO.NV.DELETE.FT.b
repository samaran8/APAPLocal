* @ValidationCode : MjotMTE1MjkzMjA0NTpDcDEyNTI6MTY4MjQ5MzQ2ODgwNDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 12:47:48
...
*
    ...
    CALL APAP.TAM.MULTI.GET.LOC.REF(WAPP.LST,WCAMPO,YPOS) ;*MANUAL R22 CODE CONVERSION
    WCASH   = YPOS<1,1>
    WCHECK  = YPOS<1,2>
    WCCY    = YPOS<1,3>
    WPOSLI  = YPOS<1,4>
