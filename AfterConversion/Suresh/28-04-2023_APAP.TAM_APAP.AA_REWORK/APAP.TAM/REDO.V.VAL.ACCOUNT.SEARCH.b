* @ValidationCode : MjotOTUwNTQ1MjM1OkNwMTI1MjoxNjgyNjc5NDA0MDIwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Apr 2023 16:26:44
...
*---------
    ...
    IF APPLICATION EQ 'TELLER' THEN
        ...
        CALL APAP.REDOVER.REDO.V.WRAP.SUNNEL(Y.ARRAY) ;*MANUAL R22 CODE CONVERSION
...
CHECK.SUNNEL:
    ...
    IF NOT(R.SUNNEL.DETAILS) THEN
        CALL APAP.TAM.REDO.GET.CARD.TYPE(VAR.CARD.NO,Y.ACCT,Y.CARD.TYPE) ;*MANUAL R22 CODE CONVERSION
