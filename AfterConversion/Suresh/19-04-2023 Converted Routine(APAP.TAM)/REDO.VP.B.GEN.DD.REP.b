* @ValidationCode : MjoxOTExMDM4NTczOkNwMTI1MjoxNjgxODkwNzQ0MjI3OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Apr 2023 13:22:24
...
* Log writing: process finished
    CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT ('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'REPORTE - DEBITO DIRECTO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Open File Directory
    OPEN DD.FILE.PATH ELSE
        ...
        CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT ('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'ERROR REPORTE - DEBITO DIRECTO AL ABRIR DIRECTORIO ' : DD.FILE.PATH, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Open File
    ...
    OPENSEQ DD.FILE.PATH TO DD.FILE THEN
        CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT ('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'ERROR REPORTE - DEBITO DIRECTO ARCHIVO YA EXISTE EN ' : DD.FILE.PATH, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Write File
    ...
    WHILE DD.LINE:DD.LINE.POS
        WRITESEQ DD.LINE TO DD.FILE ELSE
            CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT ('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'ERROR REPORTE - DEBITO DIRECTO NO SE PUEDE ESCRIBIR EN ' : DD.FILE.PATH, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
