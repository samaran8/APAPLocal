* @ValidationCode : MjoyODgyNjYwMDY6Q3AxMjUyOjE2ODIwNzczNDAzNTE6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Apr 2023 17:12:20
...
*
    ...
    IF R.AZ.ACCOUNT<AZ.RECORD.STATUS> EQ 'MAT' THEN
        ...
        END
        CALL APAP.TAM.REDO.GET.AZCANCEL.AMT.MODE(R.AZ.ACCOUNT,Y.AZ.ID,CANCEL.AMT,CANCEL.MODE) ;*MANUAL R22 CODE CONVERSION
