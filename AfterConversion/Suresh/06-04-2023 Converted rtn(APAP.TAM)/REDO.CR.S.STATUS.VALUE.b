* @ValidationCode : MjotNzE2MDk2NTc0OkNwMTI1MjoxNjgwNzgxNDg0MTg4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 06 Apr 2023 17:14:44
...
*06/04/2023      CONVERSION TOOL     AUTO R22 CODE CONVERSION          FM TO @FM, VM TO @VM, SM TO @SM, CHAR TO CHARX, = Y.ID.LIMIT.AUX + 0 TO += 0,
...
*
    COL.ID.LINKED = ''
    CALL APAP.AA.REDO.COL.AA.GET.LINKS.COL(Y.AA.ID.FND,COL.ID.LINKED) ;*MANUAL R22 CODE CONVERSION
