* @ValidationCode : MjotMTI1NTU0NjA4MDpDcDEyNTI6MTY4MzAwNjUxMDY2MjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 02 May 2023 11:18:30
...
* Call to the error message
        CALL APAP.TAM.S.REDO.GET.EB.ERROR.TXT(K.REC.NOT.FOUND, REDO.CUS.TXN.PARAM.ID : @VM: FN.REDO.CUS.TXN.PARAM,P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
...
* Call to the error message
        CALL APAP.TAM.S.REDO.GET.EB.ERROR.TXT(K.PARAMETER.IS.EMPTY, 'APP.ID' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
...
* Call to the error message
        CALL APAP.TAM.S.REDO.GET.EB.ERROR.TXT(K.PARAMETER.IS.EMPTY, 'RECORD.STATUS' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
...
* Call to the error message
        CALL APAP.TAM.S.REDO.GET.EB.ERROR.TXT(K.PARAMETER.IS.EMPTY, 'ID.NEW' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
RETURN
