* @ValidationCode : MjotMTc4NDk1Nzc1NzpDcDEyNTI6MTY4MjMyMzcxNzcxOTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 24 Apr 2023 13:38:37
...
*-----------*
    OUT.ARR = ''
    CALL APAP.LAPAP.DR.REG.GET.CUST.TYPE(R.CUSTOMER,OUT.ARR);*R22 AUTO CODE CONVERSION
    CUST.TYPE = OUT.ARR<1>
    CUST.ID = OUT.ARR<2>
