* @ValidationCode : MjotMjA2NjEyNzU2MjpDcDEyNTI6MTY4MzAzMDE2MjI4NzpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 May 2023 17:52:42
...
*------------------------------------------------------------------------------------------------------------------------
    ...
    IF ERROR.CODE.VALUE EQ '019' THEN
        ...
        CALL APAP.REDOCHNLS.redoInterfaceRecAct(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC) ;*R22 MANAUAL CODE CONVERSION
