* @ValidationCode : MjoxOTkyMjYzMzA0OkNwMTI1MjoxNjgxODA1MjcwOTA3OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Apr 2023 13:37:50
...
* OFAC
    CALL APAP.TAM.REDO.FIND.CUST.OFAC(OFAC.TIPO.CL,Y.CUST.NAME,OFAC.GIVEN.NAMES,OFAC.FAMILY.NAME,OFAC.CUS.NAME1,OFAC.CUS.NAME2,OFAC.CUS.TEXT,OFAC.RET) ;*Manual R22 conversion
    Y.DATA<2> = OFAC.RET
    IF OFAC.RET EQ '' THEN
* Log writing: OFAC did not return valid value YES/NO
        CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT('VPL007', 'ONLINE', '04', 'OFAC', 'ERROR EN LISTAS RESTRICTIVAS A LAS ' : TIMEDATE(), '', '', '', '', '', '', '') ;*Manual R22 conversion
    END
