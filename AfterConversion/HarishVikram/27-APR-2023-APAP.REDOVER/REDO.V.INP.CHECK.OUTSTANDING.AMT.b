* @ValidationCode : MjoyNjk2MjU2OTk6Q3AxMjUyOjE2ODI1ODk0MjgxMzI6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 15:27:08
...
* Here we gets the  outstanding principal from the customer
    ...
    CALL APAP.AA.redoGetPropertyName(Y.ARRANGEMENT.ID,'TERM.AMOUNT',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR) ;* R22 Manual Conversion - CALL method format modified
