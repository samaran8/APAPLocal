* @ValidationCode : MjotMzk4MjIyNDgzOkNwMTI1MjoxNjgxMzczNDIyNjA5OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 13 Apr 2023 13:40:22
...
*-----------------------------------------------------------------------------
    ...
    WHILE ACC.ID:ACCT.POS
        LOAN.FLAG=''
        CALL APAP.TAM.REDO.CONVERT.ACCOUNT(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT) ;*R22 Auto conversion
        CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;*R22 Auto conversion
