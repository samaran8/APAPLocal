* @ValidationCode : MjotMjEwMDM5NzUwMzpDcDEyNTI6MTY4MjUwNDA5ODk3NDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Apr 2023 15:44:58
...
*----------------------------------------------------------------------
    ...
    IF APPLICATION EQ "FUNDS.TRANSFER" THEN
        ...
        END ELSE
            CALL APAP.REDOVER.REDO.V.INP.DEFAULT.ACCT ;*R22 Manual Code Conversion
        END
    END
