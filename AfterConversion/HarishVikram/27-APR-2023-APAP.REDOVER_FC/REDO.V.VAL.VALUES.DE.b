* @ValidationCode : MjotMTMxMzE4Mzk4MTpDcDEyNTI6MTY4MjU4MzczNzUyMDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:52:17
...
PROCESS:
*======
    CALL APAP.REDOVER.REDO.V.VAL.NOMINAL.VALUE ;* R22 Manual Conversion - CALL method format modified
    CALL APAP.REDOVER.REDO.V.VAL.MAXIMUM.VALUE ;* R22 Manual Conversion - CALL method format modified
