* @ValidationCode : MjoxMDAyMTI2ODQxOkNwMTI1MjoxNjgyNTA0OTA5Mzg2OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 15:58:29
...
***********************
    ...
    R.AMT.CONDITION = ''
    ERR.AMT.MSG     = ''
    CALL APAP.TAM.redoCrrGetConditions(ARR.AMT.ID,EFF.AMT.DATE,PROP.AMT.CLASS,PROPERTY.AMT,R.AMT.CONDITION,ERR.AMT.MSG) ;*R22 Manual code conversion
...
*********************
    ...
    WHILE SEL.AA.ID:Y.AA.POS
        ...
        CALL APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.ACCOUNT,ERR.MSG) ;*R22 Manual code conversion
