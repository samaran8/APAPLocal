* @ValidationCode : MjoxNDA4MDgxNzU0OkNwMTI1MjoxNjgyNTgxOTIxODEyOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:22:01
...
*****************
    ...
    R.Condition.customer=''
    ERR.MSG=''
    CALL APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.customer,ERR.MSG)  ;*R22 MANUAL CODE CONVERSION
RETURN
...
******************
    ...
    R.Condition.limit=''
    ERR.MSG=''
    CALL APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.limit,ERR.MSG)  ;*R22 MANUAL CODE CONVERSION
...
******************
    ...
    ERR.MSG= ''
    CALL APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.schedule,ERR.MSG) ;*R22 MANUAL CODE CONVERSION
