* @ValidationCode : MjotMTM1NjYyMzk0MzpDcDEyNTI6MTY4MjU4MzY1NDU5MzpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:50:54
...
*======
    ...
    CALL APAP.REDOVER.REDO.V.VAL.VALIDAPORCENT ;* R22 Manual Conversion - CALL method format modified
    CALL APAP.REDOVER.REDO.V.VAL.CALC.MAX.COLLA ;* R22 Manual Conversion - CALL method format modified
    CALL APAP.REDOVER.REDO.V.VAL.CALCTOT ;* R22 Manual Conversion - CALL method format modified
