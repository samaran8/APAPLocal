* @ValidationCode : Mjo0NDY2NTUyODM6Q3AxMjUyOjE2ODI1ODI2MTkzNzE6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:33:39
...
*-------------
    ...
    R.Condition=''
    ERR.MSG=''
    CALL APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.charge,ERR.MSG)   ;*R22 MANUAL CODE CONVERSION
RETURN
