* @ValidationCode : MjoxNDI0MTAyNDM1OkNwMTI1MjoxNjgyNDk1Njc3NTMwOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 13:24:37
...
* For Input update the tables via the online service.
    ...
    IF V$FUNCTION EQ 'R' OR Y.REC.STAT[1,3] EQ 'RNA' THEN
        CALL APAP.REDOVER.REDO.V.FX.REF.NUM ;*MANUAL R22 CODE CONVERSION
        CALL APAP.REDOVER.REDO.V.FX.CCY.POS  ;*MANUAL R22 CODE CONVERSION
        CALL APAP.REDOVER.REDO.V.AUT.UPD.FX.POS ;*MANUAL R22 CODE CONVERSION
