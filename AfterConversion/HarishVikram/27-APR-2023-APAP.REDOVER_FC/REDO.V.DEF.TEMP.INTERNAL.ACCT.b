* @ValidationCode : MjotMTkyNDQ2MDEzOTpDcDEyNTI6MTY4MjU4ODM0MzQ5MjpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 15:09:03
...
*
    ...
    IF Y.ARR.ID[1,2] EQ 'AA' THEN
        ...
        OUT.ID = ''
        ERR.TEXT = ''
        CALL APAP.TAM.redoConvertAccount(IN.ACC.ID,IN.ARR.ID,OUT.ID,ERR.TEXT) ;* R22 Manual Conversion - CALL method format modified
        Y.ARR.ID = OUT.ID
    END
