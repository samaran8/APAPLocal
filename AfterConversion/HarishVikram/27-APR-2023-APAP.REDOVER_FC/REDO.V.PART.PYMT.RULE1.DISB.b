* @ValidationCode : MjoxOTI3MDQyOTg4OkNwMTI1MjoxNjgyNTEzMzQ2NjAzOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:19:06
...
*Modification history
*Date                Who               Reference                  Description
*18-04-2023      conversion tool     R22 Auto code conversion    SM TO @SM,FM TO @FM,VM TO @VM,++ TO +=1
...
PROCESS:
    ...
    IF APPLICATION EQ 'TELLER' THEN
        GOSUB TT.PROCESS
        CALL APAP.REDOVER.REDO.V.DEF.TT.LOAN.STATUS.COND ;* R22 Manual Conversion - CALL method format modified
    END
...
*Teller Process for checking the bills
    ...
    CALL APAP.TAM.redoCrrGetConditions(VAR.ACCT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;* R22 Manual Conversion - CALL method format modified
