* @ValidationCode : MjotNDk5ODI1NDUyOkNwMTI1MjoxNjgyNTA1NDAwNjgxOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 16:06:40
...
*
            CASE LOOP.CNT EQ 3
*
                CALL APAP.REDOVER.REDO.GET.WAIVE.CATEG(WAIVE.CAT) ;*R22 Manual Code conversion
*
        END CASE
*
        LOOP.CNT += 1
