* @ValidationCode : MjotMTc1OTIzMzcxMTpDcDEyNTI6MTY4MTcyNTU2MjY1MTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 17 Apr 2023 15:29:22
...
*************
    ...
    CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '',SEL.CLAIM.CMD) ;*Manual R22 conversion
...
***************
    ...
    CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '',SEL.REQ.CMD) ;*Manual R22 conversion
...
*****************
    ...
    CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '',SEL.COMP.CMD) ;*Manual R22 conversion
