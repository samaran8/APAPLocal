* @ValidationCode : MjotMTM1Mzk4NjMyMDpDcDEyNTI6MTY4MTM3OTk4NTkyMjpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Apr 2023 15:29:45
...
*****************
    ...
    WHILE BEN.ID:BEN.POS
        ...
        ERR.MSG = ''
        EFF.DATE = ''
        CALL APAP.TAM.REDO.CONVERT.ACCOUNT(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT);*Manual R22 conversion
