* @ValidationCode : Mjo1ODUwNjUwMTk6Q3AxMjUyOjE2ODE3MTcyMDkyNTI6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 17 Apr 2023 13:10:09
...
*--------------------------------------------------------------------------------------------------------
    ...
    CALL APAP.TAM.REDO.CHECK.APPLICATION(Y.ITEM,APPL.NAME,APPL.PATH) ;*Manual R22 conversion
