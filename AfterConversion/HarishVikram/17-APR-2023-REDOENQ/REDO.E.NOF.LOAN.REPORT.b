* @ValidationCode : Mjo4MDQ5ODkyMzg6Q3AxMjUyOjE2ODE3MjQ4Mjc1NDk6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 17 Apr 2023 15:17:07
...
*---------------------------------------------------------------------------------
    ...
    WHILE Y.VAR1 LE NO.OF.REC.ARR
        ...
        Y.SKIP.FLAG = "YES"
        CALL APAP.TAM.REDO.GET.DISBURSEMENT.DETAILS(Y.AA.ID,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB) ;*R22 Auto conversion
...
*---------------------------------------------------------------------------------
    ...
    R.CONDITION.ACCOUNT = ""
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.AA.ID,"","ACCOUNT","",R.CONDITION.ACCOUNT,"") ;*R22 Auto conversion
