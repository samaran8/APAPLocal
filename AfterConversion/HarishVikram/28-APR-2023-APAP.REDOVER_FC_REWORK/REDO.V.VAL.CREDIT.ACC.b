* @ValidationCode : MjoxODE0NjQ5NDAzOkNwMTI1MjoxNjgyNTc4NzYzMTUyOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 12:29:23
...
*****
    ...
    IF APPLICATION EQ 'TELLER' THEN
        ...
        CALL APAP.REDOVER.REDO.V.DEF.TT.LOAN.STATUS.COND   ;*R22 MANUAL CODE CONVERSION
* PACS00085210 -S
...
PROCESS.FT:
    ...
    IF APPLICATION EQ 'FUNDS.TRANSFER' THEN
        GOSUB GET.BILL.DETAILS
        CALL APAP.REDOVER.REDO.V.DEF.FT.LOAN.STATUS.COND    ;*R22 MANUAL CODE CONVERSION
        IF Y.PRINCIPAL.AMOUNT EQ '' THEN
            Y.PRINCIPAL.AMOUNT  = 0
        END
        IF Y.INTEREST.AMOUNT EQ '' THEN
