* @ValidationCode : MjotNDQxNzY0MDYwOkNwMTI1MjoxNjgyNTgzOTEwNjc1OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:55:10
...
PROCESS:
*======
    CALL APAP.REDOVER.REDO.V.VAL.NOMINAL.VALUE   ;*R22 MANUAL CODE CONVERSION
    CALL APAP.REDOVER.REDO.V.VAL.MAXIMUM.VALUE    ;*R22 MANUAL CODE CONVERSION
