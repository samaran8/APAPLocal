* @ValidationCode : MjoyMDgyMzk2MDkxOkNwMTI1MjoxNjgyMDc1Mzk3NDIxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Apr 2023 16:39:57
...
*CALL LAPAP.LOGGER('TESTLOG',ID.NEW,MSG)
    ...
    CALL APAP.TAM.REDO.HANDLE.COMM.TAX.FIELDS ;*Manual R22 conversion
*
*
RETURN
*
