* @ValidationCode : MjotMTc3Mjg5NjY3MzpDcDEyNTI6MTY4MjA1OTcxOTM0NTpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Apr 2023 12:18:39
...
** 21-04-2023 Skanda R22 Manual Conversion - added APAP.TAM
*-----------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*OVERRIDE INDICANDO QUE EL PRESTAMO NO TIENE SALDO PENDIENTE PAGO
    ...
    CALL REDO.COL.AA.GET.LINKS.COL (LOAN.AA.ID,COL.ID.LINKED)
...
* Get outstanding from AA
    CALL REDO.S.GET.OUT.BALANCE(LOAN.AA.ID,Y.TOTAL.AMT)
