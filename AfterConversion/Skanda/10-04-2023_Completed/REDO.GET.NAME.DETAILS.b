* @ValidationCode : MjoxMDEwODA2Mjg6Q3AxMjUyOjE2ODExMDcxMTYzOTk6SVRTUzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
PROCESS:
    ...
    LRT.POS = ''
    CALL APAP.TAM.MULTI.GET.LOC.REF(APPLNS,LRT.FIELDS,LRT.POS) ;* R22 Manual Conversion
