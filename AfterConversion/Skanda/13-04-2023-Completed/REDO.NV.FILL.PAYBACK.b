* @ValidationCode : MjotMTg3Mzk5NjE2NTpDcDEyNTI6MTY4MTM2MDUzMjIwNzpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*
    ...
    WCAMPO    = CHANGE(WCAMPO,@FM,@VM)
    WFLD.LST := @FM : WCAMPO
    CALL APAP.TAM.MULTI.GET.LOC.REF(WAPP.LST,WFLD.LST,YPOS) ;* R22 Manual conversion
    WPOSLI    = YPOS<1,1>
    WPOSCASH  = YPOS<1,2>
    WPOSCHECK = YPOS<1,3>
    WPOSCCY   = YPOS<1,4>
