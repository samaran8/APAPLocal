* @ValidationCode : MjotMTYzNDY0ODQ3MzpDcDEyNTI6MTY4MDY4MDYwNzg5MDpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*----------
    ...
    FLD.POS=''
    CALL APAP.TAM.MULTI.GET.LOC.REF(APPL.ARRAY,FLD.ARRAY,FLD.POS) ;*R22 Manual Conversion
