...
*---------------------------------------------------------------------------------------------
    ...
    $INSERT I_F.AC.CHARGE.REQUEST ;* R22 Auto conversion
    ...
    $INSERT I_F.REDO.CLEARING.OUTWARD ;* R22 Auto conversion
    $INSERT I_F.REDO.APAP.CLEARING.INWARD ;* R22 Auto conversion
