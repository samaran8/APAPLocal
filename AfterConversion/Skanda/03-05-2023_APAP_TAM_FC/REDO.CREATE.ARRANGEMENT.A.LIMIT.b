* @ValidationCode : MjotNzk2MDEyNDc3OkNwMTI1MjoxNjgzMDkxNDMzOTM2OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 10:53:53
...
* CALL APAP.TAM.REDO.UTIL.PROCESS.OFS(Y.OFS.MSG.REQ, Y.OFS.MSG.RES)
    CALL APAP.TAM.redoUtilProcessOfs(Y.OFS.MSG.REQ, Y.OFS.MSG.RES)
    GOSUB CHECK.PROCESS
    IF Y.ERR THEN
        RETURN
    END
