* @ValidationCode : MjotMTc4MzQ5ODcyMzpDcDEyNTI6MTY4MzExMzUzOTQzODpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 17:02:19
...
*CALL APAP.TAM.AI.REDO.KILL.SESSION ;** R22 Manual conversion - CALL method format changed
        ...
        CALL APAP.REDOCHNLS.aiRedoKillSession()
    END ELSE
...
*  CALL APAP.REDOCHNLS.REDO.VP.WS.CONSUMER(ACTIVATION, WS.DATA) ;** R22 Manual conversion - CALL method format changed
    CALL APAP.REDOCHNLS.redoVpWsConsumer(ACTIVATION, WS.DATA)
    BEGIN CASE
