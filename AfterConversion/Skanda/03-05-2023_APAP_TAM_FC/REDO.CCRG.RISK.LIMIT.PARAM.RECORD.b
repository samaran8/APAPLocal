* @ValidationCode : MjotMjExNTQ1NjY1MjpDcDEyNTI6MTY4MzEwOTY0NDY0ODpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 15:57:24
...
* CALL APAP.TAM.REDO.CCRG.CAL.MAX.AMOUNT('RECORD') ;* R22 Manual Conversion
            CALL APAP.TAM.redoCcrgCalMaxAmount('RECORD')
        END
    END ELSE
