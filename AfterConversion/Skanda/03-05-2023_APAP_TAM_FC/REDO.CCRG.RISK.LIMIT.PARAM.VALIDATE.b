* @ValidationCode : MjotNzg1NDIxNzQ2OkNwMTI1MjoxNjgzMTA5NzY5OTQ5OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 15:59:29
...
*CALL APAP.TAM.REDO.CCRG.ALLOWED.APP('VALIDATE', Y.APPLICATION)
        CALL APAP.TAM.redoCcrgAllowedApp('VALIDATE', Y.APPLICATION)
        IF END.ERROR THEN
            RETURN
        END
...
* CALL APAP.TAM.REDO.R.MULTI.GET.FIELD.NO(Y.APPLICATION,Y.FIELD.NO, R.STANDARD.SELECTION, Y.FIELD.POS)
        CALL APAP.TAM.redoRMultiGetFieldNo(Y.APPLICATION,Y.FIELD.NO, R.STANDARD.SELECTION, Y.FIELD.POS)
...
* CALL APAP.TAM.REDO.CCRG.VALIDATE.CONDITIONS(R.CONDITIONS, R.VALUES) ;* R22 Manual Conversion
        CALL APAP.TAM.redoCcrgValidateConditions(R.CONDITIONS, R.VALUES)
        IF END.ERROR THEN
            RETURN
        END
    NEXT J.VAR  ;*Fields
