* @ValidationCode : MjotNDY3MDU0MDczOkNwMTI1MjoxNjgzMTEwMDg4MTQzOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 16:04:48
...
* CALL APAP.TAM.REDO.CONVERT.ACCOUNT(ACC.ID,'',ARR.ID,ERR.TEXT) ;* R22 Manual conversion - CALL method format changed
    CALL APAP.TAM.redoConvertAccount(ACC.ID,'',ARR.ID,ERR.TEXT)
