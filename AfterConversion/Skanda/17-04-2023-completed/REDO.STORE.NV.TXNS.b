* @ValidationCode : MjoyMjUxMDkwNzE6Q3AxMjUyOjE2ODE3MDI4MjIwMDU6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 17 Apr 2023 09:10:22
...
*
    ...
    PSO = ''
    CALL APAP.TAM.MULTI.GET.LOC.REF(Y.APLS,Y.FIELDS,PSO) ;* R22 Manual conversion
    Y.TT.NXT = PSO<1,1>
    Y.TT.INIT= PSO<1,2>
    Y.FT.NXT = PSO<2,1>
    Y.FT.INIT = PSO<2,2>
