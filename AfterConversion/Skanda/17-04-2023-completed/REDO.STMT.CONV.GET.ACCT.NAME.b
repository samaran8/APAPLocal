* @ValidationCode : MjotMTAzNjIxNDk1MTpDcDEyNTI6MTY4MTcwMjgwMjMwMTpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 17 Apr 2023 09:10:02
...
*------------------------------------------------------------------------------------
    ...
    FIELD.POS = ''
    CALL APAP.TAM.MULTI.GET.LOC.REF(APPL.ARRAY,FIELD.ARRAY,FIELD.POS) ;* R22 Manual conversion
