* @ValidationCode : MjoyMDEzOTcxMjQ0OkNwMTI1MjoxNjgwNjcxNzU3NjMwOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
** 05-04-2023 Skanda R22 Manual Conversion one change line no. 79
*----------------------------------------------------------------------------
...
*
    ...
    LOC.REF.POS=" "
    CALL APAP.TAM.MULTI.GET.LOC.REF(LOC.REF.APPL,LOC.REF.FIELDS,LOC.REF.POS) ;* R22 Manual Conversion
