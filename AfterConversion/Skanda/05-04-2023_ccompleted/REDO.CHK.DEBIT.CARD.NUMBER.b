* @ValidationCode : MjotMTUyOTY5MzUzNjpDcDEyNTI6MTY4MDY3MTc1Nzc0MTpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
** 05-04-2023 Skanda R22 Manual Conversion - line no 76
*-------------------------------------------------------------------------
...
*Get the card number
    ...
    LOC.POS         = ''
    CALL APAP.TAM.MULTI.GET.LOC.REF(LOC.APPLICATION,LOC.FIELDS,LOC.POS) ;* R22 Manual Conversion
