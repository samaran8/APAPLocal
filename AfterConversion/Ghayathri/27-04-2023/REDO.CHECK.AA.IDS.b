* @ValidationCode : MjotMTUwMjQ1ODY2OkNwMTI1MjoxNjgyNTA1MDk0NDExOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 16:01:34
...
* This part gets the Loan amount
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG)
