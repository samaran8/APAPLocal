* @ValidationCode : MjoxMDI1NjQzOTg3OkNwMTI1MjoxNjgyNTEzMjg2MjQ2OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:18:06
...
*****************************
    ...
    R.Condition.limit = ''
    ERR.MSG = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID.LIMIT,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.limit,ERR.MSG)
RETURN
END
