* @ValidationCode : MjotMTM4NDY0MDY5NjpDcDEyNTI6MTY4MjUwOTI0NTExNTpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 17:10:45
...
*29-03-2023          jayasurya H                       MANUAL R22 CODE CONVERSION
*-----------------------------------------------------------------------------
...
* Plazo
    ...
    CALL APAP.AA.REDO.S.FC.AA.TERM(Y.ARR.ID, Y.AA.TERM)
