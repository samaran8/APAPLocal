* @ValidationCode : MjotNjY5Njg3MDEwOkNwMTI1MjoxNjgyNTc3OTQyOTcyOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 12:15:42
...
*--------------------------------------------------------------
    ...
    LOCATE Y.PENALTY.PROPERTY IN R.NEW(REDO.AA.BD.PROPERTY)<1,1> SETTING PROP.POS THEN
        CALL APAP.TAM.RedoGetAdjustedAmount(Y.PENALTY.PROPERTY,Y.BILL.REF,Y.BILL.CHARGE)
