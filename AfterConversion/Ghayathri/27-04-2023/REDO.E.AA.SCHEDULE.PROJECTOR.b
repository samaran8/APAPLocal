* @ValidationCode : MjoxOTQ4NzkzNDM6Q3AxMjUyOjE2ODI1MDY2MjM1OTI6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Apr 2023 16:27:03
...
* Here we call the schedule projector routine to build the array
    ...
    CALL APAP.AA.REDO.E.AA.SCHEDULE.PROJECTOR(SCHED.ARR)
...
*CHANGE VM TO FM IN Y.BILL.IDS
    ...
    WHILE Y.VAR1 LE Y.BILL.CNT
        ...
        LOCATE Y.PENAL.PROPERTY IN R.BILL.DETAILS<AA.BD.PROPERTY,1> SETTING POS THEN
            CALL TAM.BP.REDO.GET.ADJUSTED.AMOUNT(Y.PENAL.PROPERTY,Y.BILL.ID,Y.PENAL.AMT)
