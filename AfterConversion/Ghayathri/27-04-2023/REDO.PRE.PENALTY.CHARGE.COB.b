* @ValidationCode : MjotMjAwMzgwNjUyODpDcDEyNTI6MTY4MjUxMzAwNzMzOTpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:13:27
...
* Calculates the no. of cycles crossed the payment date
    ...
    CALL APAP.AA.REDO.PENALTY.NEXT.CYCLEDATE(Y.ID.DETAILS,Y.DETAILS,R.PAY.SCH,Y.CYCLE,Y.CHARGE.AMT)
...
* Here we get the Product related details and Charge frequency and Charge Percentage
    ...
    ERR.MSG = ''
    R.PAY.SCH = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PAY.SCH,ERR.MSG)
