* @ValidationCode : MjoyMDU1ODk4NTk0OkNwMTI1MjoxNjgyNTE0MjAyMjU5OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:33:22
...
***********************
    ...
    R.AMT.CONDITION = ''
    ERR.AMT.MSG     = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.AMT.ID,EFF.AMT.DATE,PROP.AMT.CLASS,PROPERTY.AMT,R.AMT.CONDITION,ERR.AMT.MSG)
