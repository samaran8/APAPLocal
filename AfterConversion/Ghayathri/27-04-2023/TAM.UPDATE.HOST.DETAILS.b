* @ValidationCode : Mjo2Nzk4ODEyNjY6Q3AxMjUyOjE2ODAyNTgzNzI0NTM6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 Mar 2023 15:56:12
...
* R.NEW(V-8) is the field RECORD.STATUS, to check for the status of the record to trace.
    ...
    IF (((R.OLD(V-7) NE '' OR V$FUNCTION EQ "D") AND (Y.RECORD.STATUS[1,2] EQ "IN" OR Y.RECORD.STATUS[1,2] EQ "RN" OR V$FUNCTION EQ "D")) OR (R.NEW(V-7) EQ 1 AND Y.RECORD.STATUS[1,2] EQ "IN")) THEN
        CALL APAP.AA.REDO.APPL.AUDIT.TRACK(Y.HOST.NAME,Y.IP.ADDRESS,R.STANDARD.SELECTION) ;*MANUAL R22 CODE CONVERSION
    END
