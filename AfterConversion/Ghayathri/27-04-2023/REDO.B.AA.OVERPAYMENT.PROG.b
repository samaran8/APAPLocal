* @ValidationCode : MjotMTk4NzY1NjgyNzpDcDEyNTI6MTY4MjU4MzI4ODE4MjpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:44:48
...
*------------------------------------------------------------------
    ...
    Y.ACCOUNT.PROPERTY = ""
    CALL REDO.GET.PROPERTY.NAME(Y.AA.ID,"ACCOUNT",R.OUT.AA.RECORD,Y.ACCOUNT.PROPERTY,OUT.ERR) ;*Manual R22 conversion
    Y.PAYSCH.PROPERTY  = ""
    CALL REDO.GET.PROPERTY.NAME(Y.AA.ID,"PAYMENT.SCHEDULE",R.OUT.AA.RECORD,Y.PAYSCH.PROPERTY,OUT.ERR) ;*Manual R22 conversion
