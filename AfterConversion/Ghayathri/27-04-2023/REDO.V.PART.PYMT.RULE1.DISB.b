* @ValidationCode : MjotMTU2Njc4NjMxOkNwMTI1MjoxNjgyNTE1MDkxODYwOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:48:11
...
PROCESS:
    ...
    IF APPLICATION EQ 'TELLER' THEN
        GOSUB TT.PROCESS
        CALL REDO.VER.BP.REDO.V.DEF.TT.LOAN.STATUS.COND
    END
