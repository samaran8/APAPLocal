* @ValidationCode : MjotMTg5MTUwNjc2NzpDcDEyNTI6MTY4MjUxMzM3Nzk5ODpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:19:37
...
*----------------------------------------------------------------------
    ...
    IF c_aalocPropClassId EQ 'INTEREST' THEN
        ...
        END
    END ELSE
        CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRANGEMENT.ID,'','INTEREST',PROPERTY,R.INT.COND,RET.ERR)
