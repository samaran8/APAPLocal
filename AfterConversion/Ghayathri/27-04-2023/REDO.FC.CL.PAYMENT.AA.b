* @ValidationCode : MjotMjg2MjE5NDYxOkNwMTI1MjoxNjgyNTg3ODM2NTU3OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 15:00:36
...
* Get all collateral linked to AA - TERM.AMOUNT
    CALL APAP.AA.REDO.COL.AA.GET.LINKS.COL(PAY.AA.ID,COL.ID.LINKED)
