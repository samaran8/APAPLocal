* @ValidationCode : MjotMjAyODY1MTkwMDpDcDEyNTI6MTY4MjU4ODg4NzYyMTpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 15:18:07
    ...
    IF PAY.AMOUNT.BALANCE THEN
        IF Y.AMOUNT GE PAY.AMOUNT.BALANCE  THEN
            ...
            IF Y.VALUE.CAPITAL GT 0 THEN ;*AUTO R22 CODE CONVERSION
                CALL APAP.AA.REDO.FC.CL.PAYMENT.AA(Y.VALUE.CAPITAL, ID.ARR)
            END ELSE
