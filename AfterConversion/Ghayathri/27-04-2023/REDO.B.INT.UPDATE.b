* @ValidationCode : MjotMzM0OTk1NzM6Q3AxMjUyOjE2ODI1ODU4MDc1NzU6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 14:26:47
...
* @ValidationInfo : Timestamp         : 26 Apr 2023 15:44:56
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : hai
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
...
*----------------------------------------------------------------------------
    ...
    R.PRIN.INT.COND=''
    ERR.MSG     = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PRINCIPAL.PROP,R.PRIN.INT.COND,ERR.MSG)
    Y.PRIN.RATE.REV.TYPE=R.PRIN.INT.COND<AA.INT.LOCAL.REF,POS.L.AA.REV.RT.TY>

    PROP.NAME='PENALTY'
    CALL APAP.AA.REDO.GET.INTEREST.PROPERTY(ARR.ID,PROP.NAME,PENALTY.PROP,ERR)
    EFF.DATE = ''
    PROP.CLASS='INTEREST'
    R.PENAL.INT.COND=''
    ERR.MSG = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PENALTY.PROP,R.PENAL.INT.COND,ERR.MSG)
