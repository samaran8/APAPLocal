* @ValidationCode : Mjo5MjcyOTYxNzM6Q3AxMjUyOjE2ODI0OTMyMzMzOTM6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Apr 2023 12:43:53
...
*****************
    ...
    R.Condition.customer=''
    ERR.MSG=''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.customer,ERR.MSG)
RETURN
...
******************
    ...
    R.Condition.limit=''
    ERR.MSG=''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.limit,ERR.MSG)
...
******************
    ...
    ERR.MSG= ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.schedule,ERR.MSG)
