* @ValidationCode : MjotODc3NTcyNTY3OkNwMTI1MjoxNjgyNTEyMzM5NDgwOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:02:19
...
*** <desc>Get the overdue condition details for the loan.</desc>
    ...
    ERR.MSG          = ''
    R.OVERDUE.COND   = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(c_aalocArrId,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.COND,ERR.MSG)
