* @ValidationCode : MjotNDUyMjE2NDk4OkNwMTI1MjoxNjgyNTEyNDUyMDIwOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:04:12
...
*
    ...
    CALL APAP.TAM.REDO.GET.INTEREST.PROPERTY(Y.ARRG.ID,PROP.NAME,OUT.PROP,ERR)
    ...
    R.ARR.COND = ''
*
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.ARR.TM.COND,ERR.MSG)
...
*
    ...
    R.ARR.COND = ''
*
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.ARR.COND,ERR.MSG)
