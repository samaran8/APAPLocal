* @ValidationCode : MjoxOTIzNzA4MzEzOkNwMTI1MjoxNjgyNDk0NDk1NjQ1OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 13:04:55
...
*-----------------------------------------------------------------------------
    ...
    R.CON.LIMIT = ''
    ERR.MSG     = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CON.LIMIT,ERR.MSG)
