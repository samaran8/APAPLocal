* @ValidationCode : MjoxNTYyNDk5Mjg5OkNwMTI1MjoxNjgyNTExNzkxODIyOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 17:53:11
...
*-------------------------------------------------
    ...
    R.CONDITION.PAYSCH = ''
    ERR.MSG = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.PAYSCH,ERR.MSG)
