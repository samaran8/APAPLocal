* @ValidationCode : MjotMjA3MDIyMjY1NDpDcDEyNTI6MTY4MjU5MTU0MTY2NzpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 16:02:21
...
* So we shouldnot blindly make the fund available in limit.
    ...
    CALL APAP.TAM.redoGetTotalOutstandingSinUncUnd(Y.ID.DETAILS,Y.PROP.AMT,Y.TOTAL.AMT)
