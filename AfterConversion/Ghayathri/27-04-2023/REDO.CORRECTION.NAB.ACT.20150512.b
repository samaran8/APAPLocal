* @ValidationCode : MjotNDk0NDYzODk2OkNwMTI1MjoxNjgyNTA1Nzc5MDMyOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 16:12:59
...
*---------------------------------------------------------------
    ...
    ERR.MSG     = ''
    R.OVERDUE.COND   = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFFEC.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.COND,ERR.MSG)
