* @ValidationCode : MjoxMDg0Njg0NTIwOkNwMTI1MjoxNjgyNTA1MzUzMDY1OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 16:05:53
...
* This is the main processing para
    ...
    IF R.NEW(FT.RECORD.STATUS) EQ 'RNAU' THEN
        ...
        IF Y.CHQ.NO THEN
            ...
            CALL APAP.AA.REDO.UPDATE.CHQ.RETURN(Y.ARR.ID)
        END
