* @ValidationCode : Mjo1NzAxNjQ5MTU6Q3AxMjUyOjE2ODI1ODY4MjAwOTU6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Apr 2023 14:43:40
...
********
    ...
    WHILE YACT.ID:AA.POSN
        ...
        IF YACTIVITY EQ 'LENDING-TAKEOVER-ARRANGEMENT' THEN
            ...
            CALL APAP.TAM.RedoGetDisbursementDetails(Y.ARR.ID,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB)
