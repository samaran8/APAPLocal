* @ValidationCode : MjoxNzE5MTgyNDczOkNwMTI1MjoxNjgyNTc3MjczODc4OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 12:04:33
...
*---------------------------------------------------------------------------------
    ...
    R.CONDITION  = ''
    ERR.MSG      = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(c_aalocArrId,EFF.DATE,Y.PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)
