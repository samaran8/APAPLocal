* @ValidationCode : MjotMTYwMDQyMDA3NjpDcDEyNTI6MTY4MjQ5MzY5Mzg4NjpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Apr 2023 12:51:33
...
GET.OVERDUE.STATUS:
    ...
    R.CONDITION.OVERDUE = ''
    ERR.MSG = ''
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG)
