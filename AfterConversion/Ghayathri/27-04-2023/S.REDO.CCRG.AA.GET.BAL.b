* @ValidationCode : MjoxNzQwODg2ODAyOkNwMTI1MjoxNjgyNTk0NzUwNDY4OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 16:55:50
...
*    Y.CURR.BILL     = BILL.DETAILS<AA.BD.CURRENCY>
    ...
    IF Y.CURR.CONTRACT NE LCCY THEN
        CALL APAP.TAM.SRedoConvLocalCurr(Y.CURR.CONTRACT,1,P.REV.RATE)
...
*Get Bill Details
    ...
    IF  Y.CURR.BILL NE LCCY THEN          ;*
        P.REV.RATE = 1
        CALL APAP.TAM.SRedoConvLocalCurr(Y.CURR.BILL,1,P.REV.RATE)
