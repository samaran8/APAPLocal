* @ValidationCode : Mjo4NDA0Mjg3MDM6Q3AxMjUyOjE2ODMyODk3NTA5MzU6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 May 2023 17:59:10
...
*--------------------------------------------------------------------------------------------------------
    Y.ID = Y.AA.ID:@FM:'YES'
    CALL APAP.TAM.RedoGetDisbursementDetails(Y.ID,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB)
...
*--------------------------------------------------------------------------------------------------------
    ...
    PROP.NAME = 'PRINCIPAL'
    CALL APAP.TAM.redoGetInterestProperty(Y.AA.ID,PROP.NAME,PRIN.PROP,ERR)
...
*--------------------------------------------------------------------------------------------------------
    ...
    CALL APAP.TAM.redoGetReportLoanPayamt(Y.AA.ID,Y.REPAY.AMOUNT,Y.DUMMY.VAR1,Y.DUMMY.VAR2)
...
*-------------------------------------------------------------------------------
    ...
    CALL APAP.TAM.redoGetTotalOutstandingSinUncUnd(Y.AA.ID,Y.PROP.AMT,Y.TOTAL.AMT)
