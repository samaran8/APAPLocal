* @ValidationCode : MjoxMzIyMDA4NDc2OkNwMTI1MjoxNjgzMTA4Mzc3NzkzOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 15:36:17
...
*
    ...
    R.ARR.COND = ''
*
    CALL APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.ARR.TM.COND,ERR.MSG)
...
*
    ...
    R.ARR.COND = ''
*
    CALL APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.ARR.COND,ERR.MSG)
