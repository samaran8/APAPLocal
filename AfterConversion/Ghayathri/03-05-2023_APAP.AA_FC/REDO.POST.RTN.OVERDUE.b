* @ValidationCode : Mjo4MTY5NDY5NjM6Q3AxMjUyOjE2ODMxMDgwMzYyNzE6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 15:30:36
...
*----------------------------------------------------------------------
    ...
    OVERDUE.CONDITION = ''
    ERR.MSG = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,OVERDUE.CONDITION,ERR.MSG)
RETURN
*----------------------------------------------------------------------
CALC.BALANCE:
*----------------------------------------------------------------------
...
*----------------------------------------------------------------------
    ...
    INTEREST.CONDITION = ''
    ERR.MSG = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,INTEREST.CONDITION,ERR.MSG)
