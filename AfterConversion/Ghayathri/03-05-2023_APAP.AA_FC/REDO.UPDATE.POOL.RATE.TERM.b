* @ValidationCode : MjoxODg2MDcxMTcyOkNwMTI1MjoxNjgzMTEwNTg5Mzc5OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 16:13:09
...
* Here we get the interest property.
    ...
    R.PRIN.COND        = ''
    ERR.MSG            = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PRIN.COND,ERR.MSG)
    ...
    R.PENAL.COND       = ''
    ERR.MSG            = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PENAL.COND,ERR.MSG)
