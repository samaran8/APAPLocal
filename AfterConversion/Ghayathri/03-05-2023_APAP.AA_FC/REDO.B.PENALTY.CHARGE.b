* @ValidationCode : MjotNTIyNjc1ODQ0OkNwMTI1MjoxNjgzMDk4NjMyNjQ3OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 12:53:52
...
*Y.CNT = 1
    ...
    CALL APAP.AA.redoPenaltyNextCycledate(Y.ID.DETAILS,Y.DETAILS,R.PAY.SCH,Y.CYCLE,Y.CHARGE.AMT)
...
* Here we get the Product related details and Charge frequency and Charge Percentage
    ...
    ERR.MSG = ''
    R.PAY.SCH = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PAY.SCH,ERR.MSG)
