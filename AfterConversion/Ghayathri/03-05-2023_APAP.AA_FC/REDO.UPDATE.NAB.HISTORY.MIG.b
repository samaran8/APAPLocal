* @ValidationCode : MjotMTEwMDI5MDUzMTpDcDEyNTI6MTY4MzExMDQ3NTA1MDpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 16:11:15
...
*-----------------------------------------------------------------------------------------------------------
    ...
    ERR.MSG     = ''
    R.OVERDUE.COND   = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFFEC.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.COND,ERR.MSG)
...
GET.INTEREST.PROPERTY:
    ...
    ERR.MSG = ''
    R.PAY.SCH.COND = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.SCH.COND,ERR.MSG)
