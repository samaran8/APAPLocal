* @ValidationCode : Mjo0MTA3NDU2ODE6Q3AxMjUyOjE2ODMxMDA4NjU0OTI6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 13:31:05
...
* Get all collateral linked to AA - TERM.AMOUNT
    CALL APAP.AA.RedoColAaGetLinksCol(PAY.AA.ID,COL.ID.LINKED)
...
* Getting current AA Outstanding Balance value
    TOTAL.AMT = ''
    CALL APAP.REDOSRTN.redoSGetOutBalance(PAY.AA.ID,TOTAL.AMT)
RETURN
