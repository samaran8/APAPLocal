* @ValidationCode : MjotOTA3OTAyMzc0OkNwMTI1MjoxNjgzMTAwNzIyNzM3OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 13:28:42
...
*JPA this is happening ONLY if it is SECURED
    IF R.REDO.CREATE.ARRANGEMENT<REDO.FC.SECURED> EQ 'SI' THEN
        CALL APAP.REDOFCFI.RedoFcArrangementAuth()
