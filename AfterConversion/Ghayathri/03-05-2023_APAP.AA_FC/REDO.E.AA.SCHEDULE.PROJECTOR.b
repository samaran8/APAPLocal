* @ValidationCode : MjoxMDk2MTMxNDExOkNwMTI1MjoxNjgzMTAwMzMzNzYwOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 13:22:13
...
* Here we call the schedule projector routine to build the array
    ...
    CALL APAP.AA.redoEAaScheduleProjector(SCHED.ARR)
