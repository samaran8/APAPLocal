* @ValidationCode : Mjo3MTczMzM2MDA6Q3AxMjUyOjE2ODMwOTkxNzM2MTY6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 13:02:53
...
* This is the main processing para
    ...
    IF R.NEW(FT.RECORD.STATUS) EQ 'RNAU' THEN
        ...
        IF Y.CHQ.NO THEN
            ...
            CALL APAP.AA.redoUpdateChqReturn(Y.ARR.ID)
        END
