* @ValidationCode : MjotNjQ3NTU4NDY0OkNwMTI1MjoxNjgyNTEzNDkwODg4OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Apr 2023 18:21:30
...
*--------------------------------------------------------------
    ...
    IN.ACC.ID = ''
    OUT.ID = ''
    CALL  APAP.TAM.REDO.CONVERT.ACCOUNT(IN.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT)
