* @ValidationCode : MjotNDAwODYyMDIwOkNwMTI1MjoxNjgzMTAxNjU0NTQ3OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 13:44:14
...
*Y.INTEREST.RATE=R.INT.ACCRUAL<AA.INT.ACC.RATE,1,1>
    ...
    CALL APAP.TAM.RedoGetInterestRate(ARR.ID,Y.INTEREST.RATE)
