* @ValidationCode : MjotMTMyMzA4NTc3NjpDcDEyNTI6MTY4MzExMDkyOTY3MDpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 16:18:49
...
***********************
    ...
    R.AMT.CONDITION = ''
    ERR.AMT.MSG     = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.AMT.ID,EFF.AMT.DATE,PROP.AMT.CLASS,PROPERTY.AMT,R.AMT.CONDITION,ERR.AMT.MSG)
...
*********************
    ...
    WHILE SEL.AA.ID:Y.AA.POS
        ...
        CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.ACCOUNT,ERR.MSG)
