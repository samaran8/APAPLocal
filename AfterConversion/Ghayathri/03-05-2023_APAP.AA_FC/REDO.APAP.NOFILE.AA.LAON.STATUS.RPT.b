* @ValidationCode : MjoxMTQzMjgxMTcxOkNwMTI1MjoxNjgzMDk0OTUyODQ3OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 11:52:32
...
***************
    COL.ID.LINKED = ''
    CALL APAP.AA.RedoColAaGetLinksCol(Y.COL.ID,COL.ID.LINKED)
