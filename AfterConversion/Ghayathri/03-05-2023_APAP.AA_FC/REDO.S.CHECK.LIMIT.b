* @ValidationCode : MjotNjAyMjY1NzU6Q3AxMjUyOjE2ODMxMDkxODI3MzA6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 15:49:42
...
*****************************
    ...
    R.Condition.limit = ''
    ERR.MSG = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID.LIMIT,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.limit,ERR.MSG)
RETURN
END
