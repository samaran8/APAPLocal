* @ValidationCode : Mjo4MDU5MTk1MzU6Q3AxMjUyOjE2ODMwOTU3NTI2MTY6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 12:05:52
...
*--------------------------------------------
    ...
    WHILE Y.VAR6 LE Y.TERM.ARR.CNT
        ...
        Y.LOAN.ACC = ''
        CALL APAP.TAM.redoConvertAccount(IN.ACC.ID,Y.ARR.ID,Y.LOAN.ACC,ERR.TEXT)
