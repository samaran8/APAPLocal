* @ValidationCode : MjotMTgzNDc2NzcyNjpDcDEyNTI6MTY4MzEwNjE2MTQ5NzpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 14:59:21
...
*-----------------------------------------------------------------------------
    ...
    OFS.STRING.FINAL = ''
    CALL APAP.AA.redoAaBuildOfs(ARR.ID,R.CONDITION,Y.ACT.PROP,OFS.STRING.FINAL)
