* @ValidationCode : MjotMTM4NzkyMDI5MzpDcDEyNTI6MTY4MzEwMDIyMzAxMTpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 13:20:23
...
* Here we will add the charge amount in the Out array
    ...
    WHILE Y.VAR1 LE Y.BILLS.CNT
        ...
        LOCATE Y.PENAL.PROPERTY IN R.BILL.DETAILS<AA.BD.PROPERTY,1> SETTING POS THEN
            ...
            CALL APAP.TAM.RedoGetAdjustedAmount(Y.PENAL.PROPERTY,Y.BILL.ID,Y.PENAL.AMT)
        ...
        LOCATE Y.CHQ.RET.PROP IN R.BILL.DETAILS<AA.BD.PROPERTY,1> SETTING POS THEN
            CALL APAP.TAM.RedoGetAdjustedAmount(Y.CHQ.RET.PROP,Y.BILL.ID,Y.CHQ.RET.AMT)
