* @ValidationCode : MjozODAxNzEzNzk6Q3AxMjUyOjE2ODMwOTE0MDEyODE6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 10:53:21
...
*---------------------------------------------------------------------------------
    ...
    R.CONDITION  = ''
    ERR.MSG      = ''
    CALL APAP.AA.redoCrrGetConditions(c_aalocArrId,EFF.DATE,Y.PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)
