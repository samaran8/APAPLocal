* @ValidationCode : MjoxODYyMzYxNjkzOkNwMTI1MjoxNjgzMTExODY5NzI2OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 16:34:29
...
*****************
    ...
    R.Condition.customer=''
    ERR.MSG=''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.customer,ERR.MSG)
RETURN
...
******************
    ...
    R.Condition.limit=''
    ERR.MSG=''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.limit,ERR.MSG)
...
******************
    ...
    ERR.MSG= ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.schedule,ERR.MSG)
