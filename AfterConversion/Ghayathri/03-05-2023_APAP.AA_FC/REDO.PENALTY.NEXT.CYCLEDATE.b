* @ValidationCode : MjoxODExNjAzNzY6Q3AxMjUyOjE2ODMxMDY5OTUwNDM6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 15:13:15
...
*TUS AA Changes - 20161019
    ...
    R.AA.ACC  = ''
    ERR.MSG           = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ACC,ERR.MSG)
...
*-----------------------------------------
    ...
    R.CONDITION.TERM  = ''
    ERR.MSG           = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG)
