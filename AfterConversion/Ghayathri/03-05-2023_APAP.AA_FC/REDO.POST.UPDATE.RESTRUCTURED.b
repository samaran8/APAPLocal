* @ValidationCode : MjotMTIxMjg2NDI2NzpDcDEyNTI6MTY4MzEwODEzMjYzODpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 15:32:12
...
*** <desc>Get the overdue condition details for the loan.</desc>
    ...
    ERR.MSG          = ''
    R.OVERDUE.COND   = ''
    CALL APAP.AA.redoCrrGetConditions(c_aalocArrId,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.COND,ERR.MSG)
