* @ValidationCode : Mjo2MTE5MjM2OTk6Q3AxMjUyOjE2ODMxMDc5NTc1MTM6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 15:29:17
...
*---------------------------------------------------
    ...
    R.CONDITION  = ''
    ERR.MSG      = ''
    CALL APAP.AA.redoCrrGetConditions(c_aalocArrId,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)
