* @ValidationCode : MjotMTg3MjA3NjkxOTpDcDEyNTI6MTY4MzEwNzg1MTUyMjpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 May 2023 15:27:31
...
*-------------------------------------------------
    ...
    R.CONDITION.PAYSCH = ''
    ERR.MSG = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.PAYSCH,ERR.MSG)
