* @ValidationCode : MjotOTM3NzM3NTExOkNwMTI1MjoxNjgzMDk5MTE0MTA1OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 13:01:54
...
GET.PREVIOUS.LOAN.STATUS:
    ...
    CALL APAP.TAM.RedoGetOverduePosition(ARR.ID,PREV.LOAN.STATUS, PREV.POS, OD.COUNT)   ;* Get the Previous OD postion
...
GET.CURRENT.LOAN.STATUS:
    ...
    CALL APAP.TAM.RedoGetOverduePosition(ARR.ID, CURRENT.LOAN.STATUS, CUR.POS, OD.COUNT)          ;*Get the Current OD postion
