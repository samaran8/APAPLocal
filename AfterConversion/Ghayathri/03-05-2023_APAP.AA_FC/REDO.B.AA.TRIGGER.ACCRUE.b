* @ValidationCode : MjotMTIyMzY0MTgyNjpDcDEyNTI6MTY4MjU4MzcyOTQ0NjpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:52:09
...
*-------------------------------------------------------
    ...
    R.OUT.AA.RECORD   = ''
    Y.ACC.PROPERTY    = ''
    CALL REDO.GET.PROPERTY.NAME(Y.AA.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,Y.ACC.PROPERTY,OUT.ERR);*Manual R22 conversion
