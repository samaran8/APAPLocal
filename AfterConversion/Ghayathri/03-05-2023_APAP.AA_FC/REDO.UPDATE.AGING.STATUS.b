* @ValidationCode : Mjo4MDMxODI2NDk6Q3AxMjUyOjE2ODMxMTAyMTc3NDk6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 May 2023 16:06:57
...
*CALL F.READ(FN.ACCOUNT, R.ACCOUNT.ID, R.ACCOUNT.REC, F.ACCOUNT, ACC.ERR)
    ...
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.ACC,ERR.MSG)
