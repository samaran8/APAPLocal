* @ValidationCode : MjoxNTAzODMyMTQyOkNwMTI1MjoxNjgzMTEyMDc2MTMxOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 16:37:56
...
GET.OVERDUE.STATUS:
    ...
    R.CONDITION.OVERDUE = ''
    ERR.MSG = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG)
