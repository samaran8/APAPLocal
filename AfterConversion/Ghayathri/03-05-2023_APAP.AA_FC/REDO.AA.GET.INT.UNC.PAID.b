* @ValidationCode : MjoxMjU1MTkwNTgwOkNwMTI1MjoxNjgyNTgwNzczNDQ2OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Apr 2023 13:02:53
...
*---------------------------------------------------------------------------------------
    ...
    Y.AMT.RET = ""
    CALL APAP.TAM.redoChkIntUncAmtNcf(ACC.ID,TXN.REF,Y.AMT.RET)
