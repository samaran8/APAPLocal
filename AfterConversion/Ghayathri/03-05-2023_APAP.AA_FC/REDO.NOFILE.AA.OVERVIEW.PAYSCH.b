* @ValidationCode : MjoyMDYyMjgzODUxOkNwMTI1MjoxNjgzMTA2MzgxNjkxOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 May 2023 15:03:01
...
*---------------------------------------------------------------
    ...
    CALL APAP.AA.redoEAaFullScheduleProjector(SCHED.ARR)
...
*----------------------------------------------
    ...
    R.CONDITION= ''
    ERR.MSG    = ''
    CALL APAP.AA.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)
