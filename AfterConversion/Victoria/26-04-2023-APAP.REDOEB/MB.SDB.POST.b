* @ValidationCode : Mjo1NjMyMDYzNTY6Q3AxMjUyOjE2ODE5Nzk1OTY3MDM6SVRTUzotMTotMToxNDI3ODoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 20 Apr 2023 14:03:16
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 14278
...
* CALL APAP.REDOEB.MB.SDB.POST.CROSSVAL ;*Manual R22 conversion
    CALL APAP.REDOEB.mbSdbPostCrossval();
    IF END.ERROR THEN
        A = 1
...
*CALL APAP.REDOEB.MB.SDB.POST.FIELD.DEFINITIONS ;*Manual R22 conversion
        CALL APAP.REDOEB.mbSdbPostFieldDefinitions();
        RETURN
