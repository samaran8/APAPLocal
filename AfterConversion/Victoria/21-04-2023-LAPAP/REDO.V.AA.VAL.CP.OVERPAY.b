$PACKAGE APAP.LAPAP
* @ValidationCode : MjoxNjE0MTc5MzUyOkNwMTI1MjoxNjgyMDczMjQyNjIwOnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Apr 2023 16:04:02
...
*-----------------------------------------------------------------------------
    ...
    $INSERT I_F.REDO.AA.OVERPAYMENT ;*MANUAL R22 CODE CONVERSION END
...
*R22 MANUAL CONVERSION
    CALL APAP.REDOSRTN.REDO.S.GET.OUT.BALANCE(Y.AA.ID,OUTSTAND.PRIN.BAL)
