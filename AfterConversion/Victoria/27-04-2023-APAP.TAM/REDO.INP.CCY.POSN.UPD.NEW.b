...
*CALL REDO.TXN.INP.CCY.POSN.UPD  ;*MANUAL R22 CODE CONVERSION;* Record will not be available when deleted from INAU, so online service will not have a r.new to use.
        CALL APAP.TAM.redoTxnInpCcyPosnUpd()
