* @ValidationCode : Mjo3ODk0MzA2NjU6Q3AxMjUyOjE2ODIwNzc3NjYxODU6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Apr 2023 17:19:26
...
*
    BEGIN CASE
        CASE R.NEW(REDO.CUS.PRF.IDENTITY.TYPE) EQ "CEDULA"
            CALL APAP.TAM.REDO.VAL.CIDENT.CUST(Y.APP.VERSION) ;*MANUAL R22 CODE CONVERSION
