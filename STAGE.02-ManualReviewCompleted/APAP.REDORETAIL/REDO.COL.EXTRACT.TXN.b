* @ValidationCode : MjotMTYyMzI5NzE4MTpDcDEyNTI6MTY4MTg4MzM1Mzg0OTpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Apr 2023 11:19:13
...
*-----------------------------------------------------------------------------
    ...
    CALL APAP.TAM.REDO.R.COL.PROCESS.TRACE(P.TYPE_PROC, P.STATUS.ERR, Y.CONTADOR, P.TABLE, Y.TYPE.TXN, C.DESC);* R22 Manual conversion - CALL method format changed
    CALL APAP.TAM.REDO.R.COL.EXTRACT.ERROR(C.DESC, "REDO.COL.EXTRACT.TXN",P.TABLE);* R22 Manual conversion - CALL method format changed
*     C.MON.TP='08'
*     C.ID.PROC = REDO.INTERFACE.PARAM.ID
