* @ValidationCode : Mjo1NTk5NTkxMDk6Q3AxMjUyOjE2ODEyMTU0OTkxNzQ6c2FtYXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Apr 2023 17:48:19
...
*********
    ...
    CUST.NO = ''
    CUST.ERR = ''
    CALL APAP.REDOSRTN.REDO.S.CUST.ID.VAL(CUST.ID,CUST.NO,CUST.ERR)
    Y.CUST.NO = CUST.NO
