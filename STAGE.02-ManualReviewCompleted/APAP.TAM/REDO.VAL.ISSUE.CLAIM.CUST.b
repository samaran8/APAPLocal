* @ValidationCode : MjotODk5MDY5MTQ4OkNwMTI1MjoxNjgxODk3MjE5NDYxOnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Apr 2023 15:10:19
...
*Mapping field values based on the customer ID
    ...
    CUST.NO = ''
    CUS.ERR = ''
    CALL APAP.TAM.REDO.S.CUST.ID.VAL(CUST.ID,CUST.NO,CUS.ERR)    ;*R22 MANUAL CODE CONVERSION
