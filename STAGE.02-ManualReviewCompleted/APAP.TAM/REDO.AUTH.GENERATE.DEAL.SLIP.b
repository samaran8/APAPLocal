* @ValidationCode : Mjo3NDE3Njc4NTpDcDEyNTI6MTY4MzAzNDI0NzUwNTpJVFNTOi0xOi0xOjQ3MjQ6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 May 2023 19:00:47
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4724
...
** R22 Manual conversion
    CALL APAP.REDORETAIL.redoCustIdentityRef(Y.CUST.ID,Y.ALT.ID,Y.CUS.NAME)
...
** R22 Manual conversion
    CALL APAP.TAM.redoConvertAccount(Y.LOAN.ACC,IN.ARR.ID,ARR.ID,ERR.TEXT)
*CALL REDO.GET.INDV.REPAY.AMT(Y.AA.PAYMENT.TXNS<Y.VAR2>,ARR.ID,TOTAL.AMT,Y.BILL.PAY.DATE)
** R22 Manual conversion
    CALL APAP.TAM.redoGetIndvRepayAmt(Y.AA.PAYMENT.TXNS<Y.VAR2>,ARR.ID,TOTAL.AMT,Y.BILL.PAY.DATE)
