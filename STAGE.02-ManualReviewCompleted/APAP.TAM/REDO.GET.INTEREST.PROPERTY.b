* @ValidationCode : MjoxMDM4NzYyMzMxOkNwMTI1MjoxNjgzMDExMzc5OTYyOklUU1M6LTE6LTE6LTQ3OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 02 May 2023 12:39:39
...
* Here Payment schedule is read for that particular arrangement
    ...
    ERR.MSG = ''
    R.PAY.SCH.COND = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(IN.AA.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.SCH.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
