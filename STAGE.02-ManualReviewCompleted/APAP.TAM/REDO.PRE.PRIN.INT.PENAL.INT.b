* @ValidationCode : MjoxMTkyMjI3MDA1OkNwMTI1MjoxNjgyNDI0MTQwNzk0OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 25 Apr 2023 17:32:20
...
*
    ...
    ERR.MSG = ''
    R.INT.ARR.COND = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.INT.ARR.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
* Here we get the Campaign type of the loan
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUSTOMER,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
* This part gets the Loan amount
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*-----------------------------------------------------------------------------
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*-----------------------------------------------------------
    ...
    ERR.MSG = ''
    R.PENAL.COND = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENAL.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
