* @ValidationCode : MjoxOTAzNjEyMDgxOkNwMTI1MjoxNjgxNzkxNTY0MjAwOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Apr 2023 09:49:24
...
DEFAULT.COND:
    ...
    IF R.AA.ARR THEN
        ...
        ERR.MSG = ''
        EFF.DATE = ''
        CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;* R22 Manual conversion
    ...
    IF PGM.VERSION EQ ',REDO.MULTI.AA.PART.ACRP.DISB' THEN
        CALL APAP.TAM.REDO.V.VAL.PDIS.AMT(Y.CRD.AC) ;* R22 Manual conversion
    END
...
*-----------------
    ...
    IF NOT(R.NEW(FT.TN.L.FT.COMPANY)) AND Y.DEBIT.ACCT.NO THEN
        ...
        CALL APAP.TAM.REDO.CONVERT.ACCOUNT(Y.DEBIT.ACCT.NO,'',OUT.ID,ERR.TEXT) ;* R22 Manual conversion
        Y.ARR.ID = OUT.ID
        ...
        R.Condition = ''
        R.ACCOUNT = ''
        CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.Condition,ERR.MSG) ;* R22 Manual conversion
