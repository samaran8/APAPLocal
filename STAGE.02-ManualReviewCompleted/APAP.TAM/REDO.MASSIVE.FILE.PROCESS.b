* @ValidationCode : MjoxOTc3Nzg3NzM2OkNwMTI1MjoxNjgzMDExMzgwODA1OklUU1M6LTE6LTE6OTY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*OFS.STRING.FINAL = ''
    CALL APAP.TAM.REDO.AA.BUILD.OFS(ARR.ID,Y.PENAL.RATE.ARRAY.OFS,Y.ACT.PROP,OFS.STRING.PENAL) ;*MANUAL R22 CODE CONVERSION
...
*---------------------------------------------------
    ...
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PRINCIPAL.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*---------------------------------------------------
    ...
    ERR.MSG = ''
    R.PENALTY.PROPERTY = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENALTY.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*---------------------------------------------------
    ...
    ERR.MSG = ''
    R.TERM.PROPERTY = ''
    CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.TERM.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
