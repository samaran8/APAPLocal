* @ValidationCode : MjotMTU5NjQ0MjQ1OTpDcDEyNTI6MTY4MDY3MTAwNDg2NzpJVFNTOi0xOi0xOjEyODU6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
* ======
    ...
    IF MAINT.COLL.MG.ORIGINAL.TOTAL.T GE MAINT.AMOUNT THEN
        ...
        CALL APAP.AA.REDO.FC.CL.MAINT.AA ;*R22 Manual Conversion - Call method format changed
    END ELSE
