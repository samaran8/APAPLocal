* @ValidationCode : MjoxMzU5NDg2NjE5OkNwMTI1MjoxNjgxOTc2MjU4ODI5OjkxNjM4Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 20 Apr 2023 13:07:38
...
PROCESS:
*======
    CALL  APAP.REDOVER.REDO.V.VAL.DISPO.INSTRU ;* R22 Manual Conversion - CALL method format modified
    CALL  APAP.REDOVER.REDO.V.VAL.CALC.MAX.COLLA ;* R22 Manual Conversion - CALL method format modified
    CALL  APAP.REDOVER.REDO.V.REDO.V.VAL.MAX.TOTAL ;* R22 Manual Conversion - CALL method format modified
    CALL  APAP.REDOVER.REDO.V.VAL.SEL.CLIE.CUEN ;* R22 Manual Conversion - CALL method format modified
    CALL  REDO.V.VAL.REA.COLLATERAL ;* R22 Manual Conversion - CALL method format modified
