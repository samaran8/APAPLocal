* @ValidationCode : MjoxNzgxMDAzNTkxOkNwMTI1MjoxNjgxNzM3ODk0ODU2OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 17 Apr 2023 18:54:54
...
*--------end---------------------------
            ...
            DESC       = Y.RESP.ERR
            CALL APAP.REDOVER.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,Y.REC.CON,EX.USER,EX.PC)    ;*R22 MANUAL CODE CONVERSION
*
    END CASE
*
*
