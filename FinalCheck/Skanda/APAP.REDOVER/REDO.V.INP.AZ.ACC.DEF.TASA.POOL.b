* @ValidationCode : MjotMTE2MzYyNDEwMjpDcDEyNTI6MTY4MTIwNzUwMzIzMDpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Apr 2023 15:35:03
...
*-------
    ...
    BUY.RATE = ''
    RATE = ''
    CALL APAP.TAM.REDO.GET.POOL.RATE(AZ.CUR,Y.DIFF.DAYS,RATE)
    BUY.RATE = RATE<2>
RETURN
END
