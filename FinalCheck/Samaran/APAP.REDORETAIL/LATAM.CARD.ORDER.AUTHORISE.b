* @ValidationCode : MjoxMjkwNjg5ODYyOkNwMTI1MjoxNjgxMjc2NTQ3OTc4OklUU1M6LTE6LTE6NDE0MzoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Apr 2023 10:45:47
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4143
...
* This section contain the code to reissue the card
    ...
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.AUTH ;*MANUAL R22 CODE CONVERSION
...
*    IF OLD.EXP.DATE NE '' THEN
    IF NEW.STATUS EQ '94' AND OLD.STATUS EQ '90' THEN
        ...
        IF FIELD(INPUT_PARAM,':',1) EQ 'FAILED' THEN
            ...
            CALL APAP.REDOCHNSL.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP.REJ,DESC,REC.CON,EX.USER,EX.PC) ;*MANUAL R22 CODE CONVERSION
