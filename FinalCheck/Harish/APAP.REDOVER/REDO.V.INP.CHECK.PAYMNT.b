* @ValidationCode : MjoxMzczMjQ1NzQ2OkNwMTI1MjoxNjgxMzkwOTQ0MzY2OjkxNjM4Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Apr 2023 18:32:24
...
*CALL EB.READLIST(SEL.CMD,SEL.LIST,'',NO.OF.REC,DATA.ERR)
    ...
    OUT.ID    = ''
    ERR.TEXT  = ''
    CALL APAP.REDOVER.REDO.CONVERT.ACCOUNT(CREDIT.ACCOUNT,IN.ARR.ID,OUT.ID,ERR.TEXT) ;* R22 Manual Conversion - CALL method format modified
