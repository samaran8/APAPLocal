* @ValidationCode : MjotOTEzNzgwODczOkNwMTI1MjoxNjgxMzg2OTAxNDM1OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Apr 2023 17:25:01
...
PROCESS.FT:
    ...
    IF APPLICATION EQ 'FUNDS.TRANSFER' THEN
        ...
        CALL APAP.REDOFCFI.REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG)   ;*R22 MANUAL CODE CONVERSION
