* @ValidationCode : MjoxMTAzNDY4MTEzOkNwMTI1MjoxNjgxMTI0OTc0MDk3OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Apr 2023 16:39:34
...
*---------------
    ...
    IF Y.RESPONSE.MSG EQ 'FAIL' OR Y.RESPONSE THEN
        ...
        EX.USER = ''
        EX.PC = ''
        CALL APAP.REDOVER.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC)
