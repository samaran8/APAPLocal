* @ValidationCode : MjotMTM1MzEwNzIxMDpDcDEyNTI6MTY4MTIwODYyNjg1OTpzYW1hcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Apr 2023 15:53:46
...
*
        ...
        IF V$FUNCTION EQ 'I' OR Y.REC.STAT EQ 'INAU' OR Y.REC.STAT EQ 'INAO' THEN   ;* PACS00240825 - S/E
            IF Y.CHANNEL.TYPE NE 'INTERNET' THEN
                CALL APAP.TAM.REDO.VAU.FXTT.DSLIP
            END
        END
*
