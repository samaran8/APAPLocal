* @ValidationCode : MjoyMDY0MTU3MzU2OkNwMTI1MjoxNjgxMTI1MTcwNTcxOnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Apr 2023 16:42:50
...
PROCESS.FT:
    ...
    IF APPLICATION EQ 'FUNDS.TRANSFER' THEN
        ...
        CALL APAP.REDOFCFI.REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG)
