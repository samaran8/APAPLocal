* @ValidationCode : MjoyNDg4MzY4ODc6Q3AxMjUyOjE2ODE5NzgxNDQ3NTg6OTE2Mzg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 20 Apr 2023 13:39:04
...
*======
    ...
    CALL APAP.REDO.VER.REDO.V.VAL.VALIDAPORCENT ;* R22 Manual Conversion - CALL method format modified
    CALL APAP.REDO.VER.REDO.V.VAL.CALC.MAX.COLLA ;* R22 Manual Conversion - CALL method format modified
    CALL APAP.REDO.VER.REDO.V.VAL.CALCTOT ;* R22 Manual Conversion - CALL method format modified
    CALL REDO.V.VAL.REA.COLLATERAL
    CALL APAP.REDO.VER.REDO.V.VAL.DISPO.COLL ;* R22 Manual Conversion - CALL method format modified
    CALL APAP.REDO.VER.REDO.V.VAL.CALC.MAX.COLLA ;* R22 Manual Conversion - CALL method format modified
