* @ValidationCode : MjotODc4MzU3MjkwOkNwMTI1MjoxNjgxMzgyNjU1MDUyOnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Apr 2023 16:14:15
...
*
    ...
    IF Y.ARR.ID[1,2] EQ 'AA' THEN
        ...
        OUT.ID = ''
        ERR.TEXT = ''
        CALL APAP.REDOFCFI.REDO.CONVERT.ACCOUNT(IN.ACC.ID,IN.ARR.ID,OUT.ID,ERR.TEXT)    ;*R22 MANUAL CODE CONVERSION
        Y.ACCT = OUT.ID
    END ELSE
        IN.ACC.ID = Y.ARR.ID
        IN.ARR.ID = ''
