* @ValidationCode : MjoxNTU5ODU1NzQwOkNwMTI1MjoxNjgxMjgyMjE2MzMwOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Apr 2023 12:20:16
...
* Here the main process of selecting the customer, after that select the products of the customer.
    ...
    IF Y.TEMP.D.RANGE.AND.VALUE EQ '' THEN
        RETURN
    END
    CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FN.CUSTOMER, '', '', SEL.CMD.CUS)	;*R22 Manual Conversion - Added APAP.REDOENQ
