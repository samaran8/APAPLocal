* @ValidationCode : Mjo1Njc3NTEyNzk6Q3AxMjUyOjE2ODEyODI5NTk3MDM6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 Apr 2023 12:32:39
...
*-----------------------------------------------------
    Y.FINAL.ARRAY = ''
    CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FN.REDO.TRANSACTION.CHAIN, '', '', SEL.CMD)	;*R22 Manual Conversion - Added APAP.REDOENQ
