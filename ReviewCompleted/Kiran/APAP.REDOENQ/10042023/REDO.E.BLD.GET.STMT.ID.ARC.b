* @ValidationCode : MjotMTU1OTUzNTM2OTpDcDEyNTI6MTY4MTEwNzU0MDM3MzpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Apr 2023 11:49:00
...
******************
    ...
    IF R.AZ.ACCOUNT THEN
        ...
        IF Y.DEP.TYPE EQ 'Reinvested' THEN
            ...
            CALL APAP.REDOENQ.REDO.E.BLD.GET.STMT.AZ.ARC(Y.INTEREST.LIQU.ACCT,Y.AZ.STMT.ID.LIST)    ;*R22 Manual Conversion - Added APAP.REDOENQ
