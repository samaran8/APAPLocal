* @ValidationCode : MjoyMDM2NTAyODY6Q3AxMjUyOjE2ODEyNzYyNjcwODU6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 Apr 2023 10:41:07
...
*~~~~~~~~~~~
    ...
    IF D.FIELDS NE '' THEN
        ...
        CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '', SEL.CR.CMD)	;*R22 Manual Conversion - Added APAP.REDOENQ
