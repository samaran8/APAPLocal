* @ValidationCode : MjotNjUwNjgzNzE2OkNwMTI1MjoxNjgwNjk2MTkyODI2OnNhbWFyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Apr 2023 17:33:12
...
*****************
    ...
    IF Y.APP.OVERRIDES THEN
        CALL APAP.REDO.API.IDENTIFY.CLASS(Y.APP.OVERRIDES,Y.CR.FLAG,Y.TR.FLAG)
    END
    IF Y.CR.FLAG THEN
...
*****************
    ...
    IF Y.APP.OVERRIDES THEN
        CALL APAP.REDOAPAP.REDO.API.IDENTIFY.CLASS(Y.APP.OVERRIDES,Y.CR.FLAG,Y.TR.FLAG)  ;*R22 MANUAL CODE CONVETRSION
    END
    IF Y.CR.FLAG THEN
...
*****************
    ...
    IF Y.APP.OVERRIDES THEN
        CALL APAP.REDOBATCH.REDO.API.IDENTIFY.CLASS(Y.APP.OVERRIDES,Y.CR.FLAG,Y.TR.FLAG) ;*R22 MANUAL CODE CONVETRSION
    END
    IF Y.CR.FLAG THEN
