* @ValidationCode : MjoxMTEyNjA2OTk0OkNwMTI1MjoxNjgxNzI4NzM5ODI2OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 17 Apr 2023 16:22:19
...
*---------------------------------------------------------------------------------------
*DATE               WHO                       REFERENCE                 DESCRIPTION
*17-04-2023       CONVERSION TOOLS            AUTO R22 CODE CONVERSION  SM to @SM, F.READ to CACHE.READ,=to EQ
...
*PACS00055015 - S
    ...
    R.BASE = ''
    CALL CACHE.READ(FN.INT.BASIS, Y.BASE, R.BASE, BASIS.ERR) ;*R22 AUTO CODE CONVERSION
    IF R.BASE THEN
...
*PACS00054884 - S
    BEGIN CASE
        CASE Y.BDY.INTEREST.TYPE EQ "1" ; ;*R22 AUTO CODE CONVERSION
