* @ValidationCode : MjotNzA3Mjg2MjU4OkNwMTI1MjoxNjgwNzg4MDE2ODMwOklUU1M6LTE6LTE6Mzk3OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
GET.PREVIOUS.LOAN.STATUS:
    ...
    CALL APAP.TAM.REDO.GET.OVERDUE.POSITION(ARR.ID,PREV.LOAN.STATUS, PREV.POS, OD.COUNT)   ;* Get the Previous OD postion - R22 Manual conversion - CALL method format changed
...
GET.CURRENT.LOAN.STATUS:
    ...
    CALL APAP.TAM.REDO.GET.OVERDUE.POSITION(ARR.ID, CURRENT.LOAN.STATUS, CUR.POS, OD.COUNT)          ;*Get the Current OD postion - R22 Manual conversion - CALL method format changed
