* @ValidationCode : MjoxNTU3MjQyODAxOkNwMTI1MjoxNjgxODc3NjQ1NzMzOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Apr 2023 09:44:05
...
*-----------------------------------------------------------------------------
    ...
    CALL APAP.REDOSRTN.REDO.S.GET.PERIOD.AMTS(P.ACCOUNT.ID, Y.PROCESS.DATE, Y.PROCESS.DATE, Y.AA.BALANCE.LIST, Y.OUT.AA.AMOUNT.LIST) ;* R22 Manual conversion - CALL method format changed
