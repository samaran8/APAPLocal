* @ValidationCode : MjoxNjI3NDgyNDY5OkNwMTI1MjoxNjgxMjc2NTUwNzc5OklUU1M6LTE6LTE6MTQ1NToxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Apr 2023 10:45:50
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1455
...
*---------
    ...
    GOSUB INIT.PARA
    GOSUB PROCESS.PARA
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.VALIDATE ;* R22 manual conversion
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.PROCESS(ACCOUNT.ID,ACCOUNT,CARD.CHARGE,CHARGES,CHARGE.DATE,LCY.AMT) ;* R22 Manual Conversion
...
***
    CALL APAP.REDORETAIL.LATAM.CARD.ORDER.SPLIT.CROSSVAL.1 ;* MANUAL R22 CODE CONVERSION
*
