* @ValidationCode : MjoyNzg4MDgwNTQ6Q3AxMjUyOjE2ODIwNzMzODMzOTI6SVRTUzotMTotMTo2MDI6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
* Main process begins....
    ...
    IF D.FIELDS NE "" THEN
        ...
        CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '', SEL.AA.ARR.CMD) ;*R22 Auto conversion
...
*---------------------------------------------------------------------------------
    ...
    WHILE Y.VAR1 LE NO.OF.REC.ARR
        ...
        Y.SKIP.FLAG = "YES"
        CALL APAP.TAM.REDO.GET.DISBURSEMENT.DETAILS(Y.AA.ID,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB) ;*;*R22 Manual conversion
...
*---------------------------------------------------------------------------------
    ...
    R.CONDITION.ACCOUNT = ""
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.AA.ID,"","ACCOUNT","",R.CONDITION.ACCOUNT,"") ;*R22 Manual conversion
    Y.ALT.ID = R.CONDITION.ACCOUNT<AA.AC.ALT.ID>
    R.CONDITION.CUSTOMER = ""
    CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.AA.ID,"","CUSTOMER","",R.CONDITION.CUSTOMER,"") ;*R22 Manual conversion
