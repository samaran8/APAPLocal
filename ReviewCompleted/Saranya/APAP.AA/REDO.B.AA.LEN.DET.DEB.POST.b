* @ValidationCode : MjoxMTYxNjIzODU3OkNwMTI1MjoxNjgwMTg3NzU3ODA1OklUU1M6LTE6LTE6NjY2OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*R22 Auto conversion     Conversion Tool                29-MAR-2023           FM TO @FM, VM to @VM, SM to @SM, CHAR to CHARX, F.READ to CACHE.READ
* Manual R22 conversion  Harishvikram C                 29-MAR-2023           CALL routine format modified
*-----------------------------------------------------------------------------------------------------------------
* Include files
*-----------------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
...
*-----------------------------------------------------------------------------------------------------------------
    ...
    WHILE Y.TEMP.ID:TEMP.POS
        ...
        IF TEMP.ERR THEN
            ...
            DESC     = 'DE21-':TEMP.ERR
            CALL APAP.AA.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC) ;*Manual R22 conversion
        END ELSE
